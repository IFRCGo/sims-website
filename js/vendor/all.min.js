!function(r){function n(r){return r}function e(r,n){for(var e=0,t=n.length,u=new Array(t);e<t;++e)u[e]=r[n[e]];return u}function t(r){function n(n,e,t,u){for(;t<u;){var f=t+u>>>1;r(n[f])<e?t=f+1:u=f}return t}function e(n,e,t,u){for(;t<u;){var f=t+u>>>1;e<r(n[f])?u=f:t=f+1}return t}return e.right=e,e.left=n,e}function u(r){function n(r,n,e){for(var u=e-n,f=(u>>>1)+1;--f>0;)t(r,f,u,n);return r}function e(r,n,e){for(var u,f=e-n;--f>0;)u=r[n],r[n]=r[n+f],r[n+f]=u,t(r,1,f,n);return r}function t(n,e,t,u){for(var f,o=n[--u+e],i=r(o);(f=e<<1)<=t&&(f<t&&r(n[u+f])>r(n[u+f+1])&&f++,!(i<=r(n[u+f])));)n[u+e]=n[u+f],e=f;n[u+e]=o}return n.sort=e,n}function f(r){function n(n,t,u,f){var o,i,a,c,l=new Array(f=Math.min(u-t,f));for(i=0;i<f;++i)l[i]=n[t++];if(e(l,0,f),t<u){o=r(l[0]);do(a=r(c=n[t])>o)&&(l[0]=c,o=r(e(l,0,f)[0]));while(++t<u)}return l}var e=u(r);return n}function o(r){function n(n,e,t){for(var u=e+1;u<t;++u){for(var f=u,o=n[u],i=r(o);f>e&&r(n[f-1])>i;--f)n[f]=n[f-1];n[f]=o}return n}return n}function i(r){function n(r,n,u){return(u-n<N?t:e)(r,n,u)}function e(e,t,u){var f,o=(u-t)/6|0,i=t+o,a=u-1-o,c=t+u-1>>1,l=c-o,v=c+o,s=e[i],h=r(s),d=e[l],p=r(d),g=e[c],y=r(g),w=e[v],x=r(w),b=e[a],m=r(b);h>p&&(f=s,s=d,d=f,f=h,h=p,p=f),x>m&&(f=w,w=b,b=f,f=x,x=m,m=f),h>y&&(f=s,s=g,g=f,f=h,h=y,y=f),p>y&&(f=d,d=g,g=f,f=p,p=y,y=f),h>x&&(f=s,s=w,w=f,f=h,h=x,x=f),y>x&&(f=g,g=w,w=f,f=y,y=x,x=f),p>m&&(f=d,d=b,b=f,f=p,p=m,m=f),p>y&&(f=d,d=g,g=f,f=p,p=y,y=f),x>m&&(f=w,w=b,b=f,f=x,x=m,m=f);var A=d,k=p,O=w,E=x;e[i]=s,e[l]=e[t],e[c]=g,e[v]=e[u-1],e[a]=b;var M=t+1,U=u-2,z=k<=E&&k>=E;if(z)for(var N=M;N<=U;++N){var C=e[N],S=r(C);if(S<k)N!==M&&(e[N]=e[M],e[M]=C),++M;else if(S>k)for(;;){var q=r(e[U]);{if(!(q>k)){if(q<k){e[N]=e[M],e[M++]=e[U],e[U--]=C;break}e[N]=e[U],e[U--]=C;break}U--}}}else for(var N=M;N<=U;N++){var C=e[N],S=r(C);if(S<k)N!==M&&(e[N]=e[M],e[M]=C),++M;else if(S>E)for(;;){var q=r(e[U]);{if(!(q>E)){q<k?(e[N]=e[M],e[M++]=e[U],e[U--]=C):(e[N]=e[U],e[U--]=C);break}if(U--,U<N)break}}}if(e[t]=e[M-1],e[M-1]=A,e[u-1]=e[U+1],e[U+1]=O,n(e,t,M-1),n(e,U+2,u),z)return e;if(M<i&&U>a){for(var F,q;(F=r(e[M]))<=k&&F>=k;)++M;for(;(q=r(e[U]))<=E&&q>=E;)--U;for(var N=M;N<=U;N++){var C=e[N],S=r(C);if(S<=k&&S>=k)N!==M&&(e[N]=e[M],e[M]=C),M++;else if(S<=E&&S>=E)for(;;){var q=r(e[U]);{if(!(q<=E&&q>=E)){q<k?(e[N]=e[M],e[M++]=e[U],e[U--]=C):(e[N]=e[U],e[U--]=C);break}if(U--,U<N)break}}}}return n(e,M,U+1)}var t=o(r);return n}function a(r){for(var n=new Array(r),e=-1;++e<r;)n[e]=0;return n}function c(r,n){for(var e=r.length;e<n;)r[e++]=0;return r}function l(r,n){if(n>32)throw new Error("invalid array width!");return r}function v(r,n){return function(e){var t=e.length;return[r.left(e,n,0,t),r.right(e,n,0,t)]}}function s(r,n){var e=n[0],t=n[1];return function(n){var u=n.length;return[r.left(n,e,0,u),r.left(n,t,0,u)]}}function h(r){return[0,r.length]}function d(){return null}function p(){return 0}function g(r){return r+1}function y(r){return r-1}function w(r){return function(n,e){return n+ +r(e)}}function x(r){return function(n,e){return n-r(e)}}function b(){function r(r){var n=E,e=r.length;return e&&(b=b.concat(r),z=F(z,E+=e),S.forEach(function(t){t(r,n,e)})),l}function t(){for(var r=m(E,E),n=[],e=0,t=0;e<E;++e)z[e]?r[e]=t++:n.push(e);N.forEach(function(r){r(0,[],n)}),q.forEach(function(n){n(r)});for(var u,e=0,t=0;e<E;++e)(u=z[e])&&(e!==t&&(z[t]=u,b[t]=b[e]),++t);for(b.length=t;E>t;)z[--E]=0}function o(r){function t(n,t,u){T=n.map(r),V=$(A(u),0,u),T=e(T,V);var f,o=_(T),i=o[0],a=o[1];if(W)for(f=0;f<u;++f)W(T[f],f)||(z[V[f]+t]|=Y);else{for(f=0;f<i;++f)z[V[f]+t]|=Y;for(f=a;f<u;++f)z[V[f]+t]|=Y}if(!t)return P=T,Q=V,er=i,void(tr=a);var c=P,l=Q,v=0,s=0;for(P=new Array(E),Q=m(E,E),f=0;v<t&&s<u;++f)c[v]<T[s]?(P[f]=c[v],Q[f]=l[v++]):(P[f]=T[s],Q[f]=V[s++]+t);for(;v<t;++v,++f)P[f]=c[v],Q[f]=l[v];for(;s<u;++s,++f)P[f]=T[s],Q[f]=V[s]+t;o=_(P),er=o[0],tr=o[1]}function o(r,n,e){rr.forEach(function(r){r(T,V,n,e)}),T=V=null}function a(r){for(var n,e=0,t=0;e<E;++e)z[n=Q[e]]&&(e!==t&&(P[t]=P[e]),Q[t]=r[n],++t);for(P.length=t;t<E;)Q[t++]=0;var u=_(P);er=u[0],tr=u[1]}function c(r){var n=r[0],e=r[1];if(W)return W=null,G(function(r,t){return n<=t&&t<e}),er=n,tr=e,X;var t,u,f,o=[],i=[];if(n<er)for(t=n,u=Math.min(er,e);t<u;++t)z[f=Q[t]]^=Y,o.push(f);else if(n>er)for(t=er,u=Math.min(n,tr);t<u;++t)z[f=Q[t]]^=Y,i.push(f);if(e>tr)for(t=Math.max(n,tr),u=e;t<u;++t)z[f=Q[t]]^=Y,o.push(f);else if(e<tr)for(t=Math.max(er,e),u=tr;t<u;++t)z[f=Q[t]]^=Y,i.push(f);return er=n,tr=e,N.forEach(function(r){r(Y,o,i)}),X}function l(r){return null==r?B():Array.isArray(r)?j(r):"function"==typeof r?D(r):C(r)}function C(r){return c((_=v(O,r))(P))}function j(r){return c((_=s(O,r))(P))}function B(){return c((_=h)(P))}function D(r){return _=h,G(W=r),er=0,tr=E,X}function G(r){var n,e,t,u=[],f=[];for(n=0;n<E;++n)!(z[e=Q[n]]&Y)^!!(t=r(P[n],n))&&(t?(z[e]&=Z,u.push(e)):(z[e]|=Y,f.push(e)));N.forEach(function(r){r(Y,u,f)})}function H(r){for(var n,e=[],t=tr;--t>=er&&r>0;)z[n=Q[t]]||(e.push(b[n]),--r);return e}function I(r){for(var n,e=[],t=er;t<tr&&r>0;)z[n=Q[t]]||(e.push(b[n]),--r),t++;return e}function J(r){function e(n,e,t,u){function f(){++T===L&&(w=R(w,K<<=1),B=R(B,K),L=k(K))}var l,v,s,h,p,g,y=j,w=m(T,L),x=H,A=J,O=T,M=0,U=0;for(X&&(x=A=d),j=new Array(T),T=0,B=O>1?F(B,E):m(E,L),O&&(s=(v=y[0]).key);U<u&&!((h=r(n[U]))>=h);)++U;for(;U<u;){for(v&&s<=h?(p=v,g=s,w[M]=T,(v=y[++M])&&(s=v.key)):(p={key:h,value:A()},g=h),j[T]=p;!(h>g||(B[l=e[U]+t]=T,z[l]&Z||(p.value=x(p.value,b[l])),++U>=u));)h=r(n[U]);f()}for(;M<O;)j[w[M]=T]=y[M++],f();if(T>M)for(M=0;M<t;++M)B[M]=w[B[M]];l=N.indexOf(V),T>1?(V=o,W=a):(!T&&$&&(T=1,j=[{key:null,value:A()}]),1===T?(V=i,W=c):(V=d,W=d),B=null),N[l]=V}function t(){if(T>1){for(var r=T,n=j,e=m(r,r),t=0,u=0;t<E;++t)z[t]&&(e[B[u]=B[t]]=1,++u);for(j=[],T=0,t=0;t<r;++t)e[t]&&(e[t]=T++,j.push(n[t]));if(T>1)for(var t=0;t<u;++t)B[t]=e[B[t]];else B=null;N[N.indexOf(V)]=T>1?(W=a,V=o):1===T?(W=c,V=i):W=V=d}else if(1===T){if($)return;for(var t=0;t<E;++t)if(z[t])return;j=[],T=0,N[N.indexOf(V)]=V=W=d}}function o(r,n,e){if(r!==Y&&!X){var t,u,f,o;for(t=0,f=n.length;t<f;++t)z[u=n[t]]&Z||(o=j[B[u]],o.value=H(o.value,b[u]));for(t=0,f=e.length;t<f;++t)(z[u=e[t]]&Z)===r&&(o=j[B[u]],o.value=I(o.value,b[u]))}}function i(r,n,e){if(r!==Y&&!X){var t,u,f,o=j[0];for(t=0,f=n.length;t<f;++t)z[u=n[t]]&Z||(o.value=H(o.value,b[u]));for(t=0,f=e.length;t<f;++t)(z[u=e[t]]&Z)===r&&(o.value=I(o.value,b[u]))}}function a(){var r,n;for(r=0;r<T;++r)j[r].value=J();for(r=0;r<E;++r)z[r]&Z||(n=j[B[r]],n.value=H(n.value,b[r]))}function c(){var r,n=j[0];for(n.value=J(),r=0;r<E;++r)z[r]&Z||(n.value=H(n.value,b[r]))}function l(){return X&&(W(),X=!1),j}function v(r){var n=D(l(),0,j.length,r);return G.sort(n,0,n.length)}function s(r,n,e){return H=r,I=n,J=e,X=!0,S}function h(){return s(g,y,p)}function A(r){return s(w(r),x(r),p)}function O(r){function n(n){return r(n.value)}return D=f(n),G=u(n),S}function M(){return O(n)}function U(){return T}function C(){var r=N.indexOf(V);return r>=0&&N.splice(r,1),r=rr.indexOf(e),r>=0&&rr.splice(r,1),r=q.indexOf(t),r>=0&&q.splice(r,1),S}var S={top:v,all:l,reduce:s,reduceCount:h,reduceSum:A,order:O,orderNatural:M,size:U,dispose:C,remove:C};nr.push(S);var j,B,D,G,H,I,J,K=8,L=k(K),T=0,V=d,W=d,X=!0,$=r===d;return arguments.length<1&&(r=n),N.push(V),rr.push(e),q.push(t),e(P,Q,0,E),h().orderNatural()}function K(){var r=J(d),n=r.all;return delete r.all,delete r.top,delete r.order,delete r.orderNatural,delete r.size,r.value=function(){return n()[0].value},r}function L(){nr.forEach(function(r){r.dispose()});var r=S.indexOf(t);return r>=0&&S.splice(r,1),r=S.indexOf(o),r>=0&&S.splice(r,1),r=q.indexOf(a),r>=0&&q.splice(r,1),M&=Z,B()}var P,Q,T,V,W,X={filter:l,filterExact:C,filterRange:j,filterFunction:D,filterAll:B,top:H,bottom:I,group:J,groupAll:K,dispose:L,remove:L},Y=~M&-~M,Z=~Y,$=i(function(r){return T[r]}),_=h,rr=[],nr=[],er=0,tr=0;return S.unshift(t),S.push(o),q.push(a),M|=Y,(U>=32?!Y:M&-(1<<U))&&(z=R(z,U<<=1)),t(b,0,E),o(b,0,E),X}function a(){function r(r,n){var e;if(!h)for(e=n;e<E;++e)z[e]||(a=c(a,b[e]))}function n(r,n,e){var t,u,f;if(!h){for(t=0,f=n.length;t<f;++t)z[u=n[t]]||(a=c(a,b[u]));for(t=0,f=e.length;t<f;++t)z[u=e[t]]===r&&(a=l(a,b[u]))}}function e(){var r;for(a=v(),r=0;r<E;++r)z[r]||(a=c(a,b[r]))}function t(r,n,e){return c=r,l=n,v=e,h=!0,s}function u(){return t(g,y,p)}function f(r){return t(w(r),x(r),p)}function o(){return h&&(e(),h=!1),a}function i(){var e=N.indexOf(n);return e>=0&&N.splice(e),e=S.indexOf(r),e>=0&&S.splice(e),s}var a,c,l,v,s={reduce:t,reduceCount:u,reduceSum:f,value:o,dispose:i,remove:i},h=!0;return N.push(n),S.push(r),r(b,0,E),u()}function c(){return E}var l={add:r,remove:t,dimension:o,groupAll:a,size:c},b=[],E=0,M=0,U=8,z=C(0),N=[],S=[],q=[];return arguments.length?r(arguments[0]):l}function m(r,n){return(n<257?C:n<65537?S:q)(r)}function A(r){for(var n=m(r,r),e=-1;++e<r;)n[e]=e;return n}function k(r){return 8===r?256:16===r?65536:4294967296}b.version="1.3.14",b.permute=e;var O=b.bisect=t(n);O.by=t;var E=b.heap=u(n);E.by=u;var M=b.heapselect=f(n);M.by=f;var U=b.insertionsort=o(n);U.by=o;var z=b.quicksort=i(n);z.by=i;var N=32,C=a,S=a,q=a,F=c,R=l;"undefined"!=typeof Uint8Array&&(C=function(r){return new Uint8Array(r)},S=function(r){return new Uint16Array(r)},q=function(r){return new Uint32Array(r)},F=function(r,n){if(r.length>=n)return r;var e=new r.constructor(n);return e.set(r),e},R=function(r,n){var e;switch(n){case 16:e=S(r.length);break;case 32:e=q(r.length);break;default:throw new Error("invalid array width!")}return e.set(r),e}),r.crossfilter=b}("undefined"!=typeof exports&&exports||this);
...
!function(){function t(t,e){"use strict";var n={version:"2.0.1",constants:{CHART_CLASS:"dc-chart",DEBUG_GROUP_CLASS:"debug",STACK_CLASS:"stack",DESELECTED_CLASS:"deselected",SELECTED_CLASS:"selected",NODE_INDEX_NAME:"__index__",GROUP_INDEX_NAME:"__group_index__",DEFAULT_CHART_GROUP:"__default_chart_group__",EVENT_DELAY:40,NEGLIGIBLE_NUMBER:1e-10},_renderlet:null};n.chartRegistry=function(){function t(t){return t||(t=n.constants.DEFAULT_CHART_GROUP),e[t]||(e[t]=[]),t}var e={};return{has:function(t){for(var n in e)if(e[n].indexOf(t)>=0)return!0;return!1},register:function(n,r){r=t(r),e[r].push(n)},deregister:function(n,r){r=t(r);for(var i=0;i<e[r].length;i++)if(e[r][i].anchorName()===n.anchorName()){e[r].splice(i,1);break}},clear:function(t){t?delete e[t]:e={}},list:function(n){return n=t(n),e[n]}}}(),n.registerChart=function(t,e){n.chartRegistry.register(t,e)},n.deregisterChart=function(t,e){n.chartRegistry.deregister(t,e)},n.hasChart=function(t){return n.chartRegistry.has(t)},n.deregisterAllCharts=function(t){n.chartRegistry.clear(t)},n.filterAll=function(t){for(var e=n.chartRegistry.list(t),r=0;r<e.length;++r)e[r].filterAll()},n.refocusAll=function(t){for(var e=n.chartRegistry.list(t),r=0;r<e.length;++r)e[r].focus&&e[r].focus()},n.renderAll=function(t){for(var e=n.chartRegistry.list(t),r=0;r<e.length;++r)e[r].render();null!==n._renderlet&&n._renderlet(t)},n.redrawAll=function(t){for(var e=n.chartRegistry.list(t),r=0;r<e.length;++r)e[r].redraw();null!==n._renderlet&&n._renderlet(t)},n.disableTransitions=!1,n.transition=function(t,e,r,i){if(n.disableTransitions||e<=0)return t;var a=t.transition(i);return(e>=0||void 0!==e)&&(a=a.duration(e)),(r>=0||void 0!==r)&&(a=a.delay(r)),a},n.optionalTransition=function(t,e,r,i){return t?function(t){return n.transition(t,e,r,i)}:function(t){return t}},n.afterTransition=function(t,e){if(t.empty()||!t.duration)e.call(t);else{var n=0;t.each(function(){++n}).each("end",function(){--n||e.call(t)})}},n.units={},n.units.integers=function(t,e){return Math.abs(e-t)},n.units.ordinal=function(t,e,n){return n},n.units.fp={},n.units.fp.precision=function(t){var e=function(t,r){var i=Math.abs((r-t)/e.resolution);return n.utils.isNegligible(i-Math.floor(i))?Math.floor(i):Math.ceil(i)};return e.resolution=t,e},n.round={},n.round.floor=function(t){return Math.floor(t)},n.round.ceil=function(t){return Math.ceil(t)},n.round.round=function(t){return Math.round(t)},n.override=function(t,e,n){var r=t[e];t["_"+e]=r,t[e]=n},n.renderlet=function(t){return arguments.length?(n._renderlet=t,n):n._renderlet},n.instanceOfChart=function(t){return t instanceof Object&&t.__dcFlag__&&!0},n.errors={},n.errors.Exception=function(t){var e=t||"Unexpected internal error";this.message=e,this.toString=function(){return e},this.stack=(new Error).stack},n.errors.Exception.prototype=Object.create(Error.prototype),n.errors.Exception.prototype.constructor=n.errors.Exception,n.errors.InvalidStateException=function(){n.errors.Exception.apply(this,arguments)},n.errors.InvalidStateException.prototype=Object.create(n.errors.Exception.prototype),n.errors.InvalidStateException.prototype.constructor=n.errors.InvalidStateException,n.errors.BadArgumentException=function(){n.errors.Exception.apply(this,arguments)},n.errors.BadArgumentException.prototype=Object.create(n.errors.Exception.prototype),n.errors.BadArgumentException.prototype.constructor=n.errors.BadArgumentException,n.dateFormat=t.time.format("%m/%d/%Y"),n.printers={},n.printers.filters=function(t){for(var e="",r=0;r<t.length;++r)r>0&&(e+=", "),e+=n.printers.filter(t[r]);return e},n.printers.filter=function(t){var e="";return"undefined"!=typeof t&&null!==t&&(t instanceof Array?t.length>=2?e="["+n.utils.printSingleValue(t[0])+" -> "+n.utils.printSingleValue(t[1])+"]":t.length>=1&&(e=n.utils.printSingleValue(t[0])):e=n.utils.printSingleValue(t)),e},n.pluck=function(t,e){return e?function(n,r){return e.call(n,n[t],r)}:function(e){return e[t]}},n.utils={},n.utils.printSingleValue=function(t){var e=""+t;return t instanceof Date?e=n.dateFormat(t):"string"==typeof t?e=t:n.utils.isFloat(t)?e=n.utils.printSingleValue.fformat(t):n.utils.isInteger(t)&&(e=Math.round(t)),e},n.utils.printSingleValue.fformat=t.format(".2f"),n.utils.add=function(e,n,r){if("string"==typeof n&&(n=n.replace("%","")),e instanceof Date)return"string"==typeof n&&(n=+n),"millis"===r?new Date(e.getTime()+n):(r=r||"day",t.time[r].offset(e,n));if("string"==typeof n){var i=+n/100;return e>0?e*(1+i):e*(1-i)}return e+n},n.utils.subtract=function(e,n,r){if("string"==typeof n&&(n=n.replace("%","")),e instanceof Date)return"string"==typeof n&&(n=+n),"millis"===r?new Date(e.getTime()-n):(r=r||"day",t.time[r].offset(e,-n));if("string"==typeof n){var i=+n/100;return e<0?e*(1+i):e*(1-i)}return e-n},n.utils.isNumber=function(t){return t===+t},n.utils.isFloat=function(t){return t===+t&&t!==(0|t)},n.utils.isInteger=function(t){return t===+t&&t===(0|t)},n.utils.isNegligible=function(t){return!n.utils.isNumber(t)||t<n.constants.NEGLIGIBLE_NUMBER&&t>-n.constants.NEGLIGIBLE_NUMBER},n.utils.clamp=function(t,e,n){return t<e?e:t>n?n:t};var r=0;return n.utils.uniqueId=function(){return++r},n.utils.nameToId=function(t){return t.toLowerCase().replace(/[\s]/g,"_").replace(/[\.']/g,"")},n.utils.appendOrSelect=function(t,e,n){n=n||e;var r=t.select(e);return r.empty()&&(r=t.append(n)),r},n.utils.safeNumber=function(t){return n.utils.isNumber(+t)?+t:0},n.logger={},n.logger.enableDebugLog=!1,n.logger.warn=function(t){return console&&(console.warn?console.warn(t):console.log&&console.log(t)),n.logger},n.logger.debug=function(t){return n.logger.enableDebugLog&&console&&(console.debug?console.debug(t):console.log&&console.log(t)),n.logger},n.logger.deprecate=function(t,e){function r(){return i||(n.logger.warn(e),i=!0),t.apply(this,arguments)}var i=!1;return r},n.events={current:null},n.events.trigger=function(t,e){return e?(n.events.current=t,void setTimeout(function(){t===n.events.current&&t()},e)):void t()},n.filters={},n.filters.RangedFilter=function(t,e){var n=new Array(t,e);return n.isFiltered=function(t){return t>=this[0]&&t<this[1]},n.filterType="RangedFilter",n},n.filters.TwoDimensionalFilter=function(t){if(null===t)return null;var e=t;return e.isFiltered=function(t){return t.length&&t.length===e.length&&t[0]===e[0]&&t[1]===e[1]},e.filterType="TwoDimensionalFilter",e},n.filters.RangedTwoDimensionalFilter=function(t){if(null===t)return null;var e,n=t;return e=n[0]instanceof Array?[[Math.min(t[0][0],t[1][0]),Math.min(t[0][1],t[1][1])],[Math.max(t[0][0],t[1][0]),Math.max(t[0][1],t[1][1])]]:[[t[0],-(1/0)],[t[1],1/0]],n.isFiltered=function(t){var n,r;return t instanceof Array?(n=t[0],r=t[1]):(n=t,r=e[0][1]),n>=e[0][0]&&n<e[1][0]&&r>=e[0][1]&&r<e[1][1]},n.filterType="RangedTwoDimensionalFilter",n},n.baseMixin=function(r){function i(){f&&f.attr("width",r.width()).attr("height",r.height())}function a(){return f=r.root().append("svg"),i(),f}function o(t){if(!r[t]||!r[t]())throw new n.errors.InvalidStateException("Mandatory attribute chart."+t+" is missing on chart[#"+r.anchorName()+"]")}function l(){if(r.dimension()&&r.dimension().filter){var t=Y(r.dimension(),P);P=t?t:P}}r.__dcFlag__=n.utils.uniqueId();var u,s,c,d,f,g,h,p,x,y,v,m=200,A=function(t){var e=t&&t.getBoundingClientRect&&t.getBoundingClientRect().width;return e&&e>m?e:m},b=A,_=200,D=function(t){var e=t&&t.getBoundingClientRect&&t.getBoundingClientRect().height;return e&&e>_?e:_},k=D,C=n.pluck("key"),L=n.pluck("value"),S=n.pluck("key"),M=n.pluck("key"),R=!1,w=function(t){return r.keyAccessor()(t)+": "+r.valueAccessor()(t)},E=!0,B=!1,T=750,O=0,N=n.printers.filters,F=["dimension","group"],G=n.constants.DEFAULT_CHART_GROUP,H=t.dispatch("preRender","postRender","preRedraw","postRedraw","filtered","zoomed","renderlet","pretransition"),P=[],Y=function(t,e){return 0===e.length?t.filter(null):1!==e.length||e[0].isFiltered?1===e.length&&"RangedFilter"===e[0].filterType?t.filterRange(e[0]):t.filterFunction(function(t){for(var n=0;n<e.length;n++){var r=e[n];if(r.isFiltered&&r.isFiltered(t))return!0;if(r<=t&&r>=t)return!0}return!1}):t.filterExact(e[0]),e},U=function(t){return t.all()};r.height=function(e){return arguments.length?(k=t.functor(e||D),p=void 0,r):(n.utils.isNumber(p)||(p=k(d.node())),p)},r.width=function(e){return arguments.length?(b=t.functor(e||A),h=void 0,r):(n.utils.isNumber(h)||(h=b(d.node())),h)},r.minWidth=function(t){return arguments.length?(m=t,r):m},r.minHeight=function(t){return arguments.length?(_=t,r):_},r.dimension=function(t){return arguments.length?(u=t,r.expireCache(),r):u},r.data=function(e){return arguments.length?(U=t.functor(e),r.expireCache(),r):U.call(r,s)},r.group=function(t,e){return arguments.length?(s=t,r._groupName=e,r.expireCache(),r):s},r.ordering=function(t){return arguments.length?(M=t,x=e.quicksort.by(M),r.expireCache(),r):M},r._computeOrderedGroups=function(t){var n=t.slice(0);return n.length<=1?n:(x||(x=e.quicksort.by(M)),x(n,0,n.length))},r.filterAll=function(){return r.filter(null)},r.select=function(t){return d.select(t)},r.selectAll=function(t){return d?d.selectAll(t):null},r.anchor=function(e,i){if(!arguments.length)return c;if(n.instanceOfChart(e))c=e.anchor(),d=e.root(),g=!0;else{if(!e)throw new n.errors.BadArgumentException("parent must be defined");c=e.select&&e.classed?e.node():e,d=t.select(c),d.classed(n.constants.CHART_CLASS,!0),n.registerChart(r,i),g=!1}return G=i,r},r.anchorName=function(){var t=r.anchor();return t&&t.id?t.id:t&&t.replace?t.replace("#",""):"dc-chart"+r.chartID()},r.root=function(t){return arguments.length?(d=t,r):d},r.svg=function(t){return arguments.length?(f=t,r):f},r.resetSvg=function(){return r.select("svg").remove(),a()},r.filterPrinter=function(t){return arguments.length?(N=t,r):N},r.controlsUseVisibility=function(t){return arguments.length?(B=t,r):B},r.turnOnControls=function(){if(d){var t=r.controlsUseVisibility()?"visibility":"display";r.selectAll(".reset").style(t,null),r.selectAll(".filter").text(N(r.filters())).style(t,null)}return r},r.turnOffControls=function(){if(d){var t=r.controlsUseVisibility()?"visibility":"display",e=r.controlsUseVisibility()?"hidden":"none";r.selectAll(".reset").style(t,e),r.selectAll(".filter").style(t,e).text(r.filter())}return r},r.transitionDuration=function(t){return arguments.length?(T=t,r):T},r.transitionDelay=function(t){return arguments.length?(O=t,r):O},r._mandatoryAttributes=function(t){return arguments.length?(F=t,r):F},r.render=function(){p=h=void 0,H.preRender(r),F&&F.forEach(o);var t=r._doRender();return y&&y.render(),r._activateRenderlets("postRender"),t},r._activateRenderlets=function(t){H.pretransition(r),r.transitionDuration()>0&&f?f.transition().duration(r.transitionDuration()).delay(r.transitionDelay()).each("end",function(){H.renderlet(r),t&&H[t](r)}):(H.renderlet(r),t&&H[t](r))},r.redraw=function(){i(),H.preRedraw(r);var t=r._doRedraw();return y&&y.render(),r._activateRenderlets("postRedraw"),t},r.commitHandler=function(t){return arguments.length?(v=t,r):v},r.redrawGroup=function(){return v?v(!1,function(t,e){t?console.log(t):n.redrawAll(r.chartGroup())}):n.redrawAll(r.chartGroup()),r},r.renderGroup=function(){return v?v(!1,function(t,e){t?console.log(t):n.renderAll(r.chartGroup())}):n.renderAll(r.chartGroup()),r},r._invokeFilteredListener=function(t){void 0!==t&&H.filtered(r,t)},r._invokeZoomedListener=function(){H.zoomed(r)};var I=function(t,e){return null===e||"undefined"==typeof e?t.length>0:t.some(function(t){return e<=t&&e>=t})};r.hasFilterHandler=function(t){return arguments.length?(I=t,r):I},r.hasFilter=function(t){return I(P,t)};var z=function(t,e){for(var n=0;n<t.length;n++)if(t[n]<=e&&t[n]>=e){t.splice(n,1);break}return t};r.removeFilterHandler=function(t){return arguments.length?(z=t,r):z};var V=function(t,e){return t.push(e),t};r.addFilterHandler=function(t){return arguments.length?(V=t,r):V};var X=function(t){return[]};return r.resetFilterHandler=function(t){return arguments.length?(X=t,r):X},r.replaceFilter=function(t){P=X(P),r.filter(t)},r.filter=function(t){return arguments.length?(t instanceof Array&&t[0]instanceof Array&&!t.isFiltered?t[0].forEach(function(t){r.hasFilter(t)?z(P,t):V(P,t)}):null===t?P=X(P):r.hasFilter(t)?z(P,t):V(P,t),l(),r._invokeFilteredListener(t),null!==d&&r.hasFilter()?r.turnOnControls():r.turnOffControls(),r):P.length>0?P[0]:null},r.filters=function(){return P},r.highlightSelected=function(e){t.select(e).classed(n.constants.SELECTED_CLASS,!0),t.select(e).classed(n.constants.DESELECTED_CLASS,!1)},r.fadeDeselected=function(e){t.select(e).classed(n.constants.SELECTED_CLASS,!1),t.select(e).classed(n.constants.DESELECTED_CLASS,!0)},r.resetHighlight=function(e){t.select(e).classed(n.constants.SELECTED_CLASS,!1),t.select(e).classed(n.constants.DESELECTED_CLASS,!1)},r.onClick=function(t){var e=r.keyAccessor()(t);n.events.trigger(function(){r.filter(e),r.redrawGroup()})},r.filterHandler=function(t){return arguments.length?(Y=t,r):Y},r._doRender=function(){return r},r._doRedraw=function(){return r},r.legendables=function(){return[]},r.legendHighlight=function(){},r.legendReset=function(){},r.legendToggle=function(){},r.isLegendableHidden=function(){return!1},r.keyAccessor=function(t){return arguments.length?(C=t,r):C},r.valueAccessor=function(t){return arguments.length?(L=t,r):L},r.label=function(t,e){return arguments.length?(S=t,(void 0===e||e)&&(R=!0),r):S},r.renderLabel=function(t){return arguments.length?(R=t,r):R},r.title=function(t){return arguments.length?(w=t,r):w},r.renderTitle=function(t){return arguments.length?(E=t,r):E},r.renderlet=n.logger.deprecate(function(t){return r.on("renderlet."+n.utils.uniqueId(),t),r},'chart.renderlet has been deprecated.  Please use chart.on("renderlet.<renderletKey>", renderletFunction)'),r.chartGroup=function(t){return arguments.length?(g||n.deregisterChart(r,G),G=t,g||n.registerChart(r,G),r):G},r.expireCache=function(){return r},r.legend=function(t){return arguments.length?(y=t,y.parent(r),r):y},r.chartID=function(){return r.__dcFlag__},r.options=function(t){var e=["anchor","group","xAxisLabel","yAxisLabel","stack","title","point","getColor","overlayGeoJson"];for(var i in t)"function"==typeof r[i]?t[i]instanceof Array&&e.indexOf(i)!==-1?r[i].apply(r,t[i]):r[i].call(r,t[i]):n.logger.debug("Not a valid option setter name: "+i);return r},r.on=function(t,e){return H.on(t,e),r},r},n.marginMixin=function(t){var e={top:10,right:50,bottom:30,left:30};return t.margins=function(n){return arguments.length?(e=n,t):e},t.effectiveWidth=function(){return t.width()-t.margins().left-t.margins().right},t.effectiveHeight=function(){return t.height()-t.margins().top-t.margins().bottom},t},n.colorMixin=function(e){var r=t.scale.category20c(),i=!0,a=function(t){return e.keyAccessor()(t)};return e.colors=function(n){return arguments.length?(r=n instanceof Array?t.scale.quantize().range(n):t.functor(n),e):r},e.ordinalColors=function(n){return e.colors(t.scale.ordinal().range(n))},e.linearColors=function(n){return e.colors(t.scale.linear().range(n).interpolate(t.interpolateHcl))},e.colorAccessor=function(t){return arguments.length?(a=t,i=!1,e):a},e.defaultColorAccessor=function(){return i},e.colorDomain=function(t){return arguments.length?(r.domain(t),e):r.domain()},e.calculateColorDomain=function(){var n=[t.min(e.data(),e.colorAccessor()),t.max(e.data(),e.colorAccessor())];return r.domain(n),e},e.getColor=function(t,e){return r(a.call(this,t,e))},e.colorCalculator=n.logger.deprecate(function(t){return arguments.length?(e.getColor=t,e):e.getColor},"colorMixin.colorCalculator has been deprecated. Please colorMixin.colors and colorMixin.colorAccessor instead"),e},n.coordinateGridMixin=function(e){function r(t,e){return!t||!e||t.length!==e.length||t.some(function(t,n){return t&&e[n]?t.toString()!==e[n].toString():t===e[n]})}function i(t,n){e.isOrdinal()?(e.elasticX()||0===C.domain().length)&&C.domain(e._ordinalXDomain()):e.elasticX()&&C.domain([e.xAxisMin(),e.xAxisMax()]);var i=C.domain();(n||r(M,i))&&e.rescale(),M=i,e.isOrdinal()?C.rangeBands([0,e.xAxisLength()],at,e._useOuterPadding()?it:0):C.range([0,e.xAxisLength()]),N=N.scale(e.x()),a(t)}function a(t){var r=t.select("g."+v);if(W){r.empty()&&(r=t.insert("g",":first-child").attr("class",x+" "+v).attr("transform","translate("+e.margins().left+","+e.margins().top+")"));var i=N.tickValues()?N.tickValues():"function"==typeof C.ticks?C.ticks(N.ticks()[0]):C.domain(),a=r.selectAll("line").data(i),o=a.enter().append("line").attr("x1",function(t){return C(t)}).attr("y1",e._xAxisY()-e.margins().top).attr("x2",function(t){return C(t)}).attr("y2",0).attr("opacity",0);n.transition(o,e.transitionDuration(),e.transitionDelay()).attr("opacity",1),n.transition(a,e.transitionDuration(),e.transitionDelay()).attr("x1",function(t){return C(t)}).attr("y1",e._xAxisY()-e.margins().top).attr("x2",function(t){return C(t)}).attr("y2",0),a.exit().remove()}else r.selectAll("line").remove()}function o(){return e._xAxisY()-e.margins().top}function l(){return e.anchorName().replace(/[ .#=\[\]]/g,"-")+"-clip"}function u(){var t=n.utils.appendOrSelect(_,"defs"),r=l(),i=n.utils.appendOrSelect(t,"#"+r,"clipPath").attr("id",r),a=2*rt;n.utils.appendOrSelect(i,"rect").attr("width",e.xAxisLength()+a).attr("height",e.yAxisHeight()+a).attr("transform","translate(-"+rt+", -"+rt+")")}function s(t){e.isOrdinal()&&(q=!1),i(e.g(),t),e._prepareYAxis(e.g()),e.plotData(),(e.elasticX()||Z||t)&&e.renderXAxis(e.g()),(e.elasticY()||Z||t)&&e.renderYAxis(e.g()),t?e.renderBrush(e.g(),!1):e.redrawBrush(e.g(),Z),e.fadeDeselectedArea(),Z=!1}function c(){nt?e._enableMouseZoom():et&&e._disableMouseZoom()}function d(){if(j=!0,Q){var t=L;T&&(t=f(t,T.x().domain()));var r=g(e.x().domain(),t);r&&e.x().domain(r)}var i=e.x().domain(),a=n.filters.RangedFilter(i[0],i[1]);e.replaceFilter(a),e.rescale(),e.redraw(),T&&!h(e.filter(),T.filter())&&n.events.trigger(function(){T.replaceFilter(a),T.redraw()}),e._invokeZoomedListener(),n.events.trigger(function(){e.redrawGroup()},n.constants.EVENT_DELAY),j=!h(i,L)}function f(t,e){return(t[0]>e[1]||t[1]<e[0])&&console.warn("could not intersect extents"),[Math.max(t[0],e[0]),Math.min(t[1],e[1])]}function g(t,e){var r=t[1]-t[0];return t[0]<e[0]?[e[0],Math.min(e[1],n.utils.add(e[0],r,"millis"))]:t[1]>e[1]?[Math.max(e[0],n.utils.subtract(e[1],r,"millis")),e[1]]:null}function h(t,e){return!t&&!e||!(!t||!e)&&(0===t.length&&0===e.length||t[0].valueOf()===e[0].valueOf()&&t[1].valueOf()===e[1].valueOf())}function p(t){return t instanceof Array&&t.length>1}var x="grid-line",y="horizontal",v="vertical",m="y-axis-label",A="x-axis-label",b=12;e=n.colorMixin(n.marginMixin(n.baseMixin(e))),e.colors(t.scale.category10()),e._mandatoryAttributes().push("x");var _,D,k,C,L,S,M,R,w,E,B,T,O,N=t.svg.axis().orient("bottom"),F=n.units.integers,G=0,H="day",P=!1,Y=0,U=t.svg.axis().orient("left"),I=0,z=!1,V=0,X=t.svg.brush(),q=!0,K=!1,W=!1,j=!1,Z=!1,J=[1,1/0],Q=!0,$=t.behavior.zoom().on("zoom",d),tt=t.behavior.zoom().on("zoom",null),et=!1,nt=!1,rt=0,it=.5,at=0,ot=!1;return e.rescale=function(){return B=void 0,Z=!0,e},e.resizing=function(){return Z},e.rangeChart=function(t){return arguments.length?(T=t,T.focusChart(e),e):T},e.zoomScale=function(t){return arguments.length?(J=t,e):J},e.zoomOutRestrict=function(t){return arguments.length?(J[0]=t?1:0,Q=t,e):Q},e._generateG=function(t){_=void 0===t?e.svg():t;var n=window.location.href.split("#")[0];return D=_.append("g"),k=D.append("g").attr("class","chart-body").attr("transform","translate("+e.margins().left+", "+e.margins().top+")").attr("clip-path","url("+n+"#"+l()+")"),D},e.g=function(t){return arguments.length?(D=t,e):D},e.mouseZoomable=function(t){return arguments.length?(nt=t,e):nt},e.chartBodyG=function(t){return arguments.length?(k=t,e):k},e.x=function(t){return arguments.length?(C=t,L=C.domain(),e.rescale(),e):C},e.xOriginalDomain=function(){return L},e.xUnits=function(t){return arguments.length?(F=t,e):F},e.xAxis=function(t){return arguments.length?(N=t,e):N},e.elasticX=function(t){return arguments.length?(P=t,e):P},e.xAxisPadding=function(t){return arguments.length?(G=t,e):G},e.xAxisPaddingUnit=function(t){return arguments.length?(H=t,e):H},e.xUnitCount=function(){if(void 0===B){var t=e.xUnits()(e.x().domain()[0],e.x().domain()[1],e.x().domain());B=t instanceof Array?t.length:t}return B},e.useRightYAxis=function(t){return arguments.length?(ot=t,e):ot},e.isOrdinal=function(){return e.xUnits()===n.units.ordinal},e._useOuterPadding=function(){return!0},e._ordinalXDomain=function(){var t=e._computeOrderedGroups(e.data());return t.map(e.keyAccessor())},e.renderXAxis=function(t){var r=t.select("g.x");r.empty()&&(r=t.append("g").attr("class","axis x").attr("transform","translate("+e.margins().left+","+e._xAxisY()+")"));var i=t.select("text."+A);i.empty()&&e.xAxisLabel()&&(i=t.append("text").attr("class",A).attr("transform","translate("+(e.margins().left+e.xAxisLength()/2)+","+(e.height()-Y)+")").attr("text-anchor","middle")),e.xAxisLabel()&&i.text()!==e.xAxisLabel()&&i.text(e.xAxisLabel()),n.transition(r,e.transitionDuration(),e.transitionDelay()).attr("transform","translate("+e.margins().left+","+e._xAxisY()+")").call(N),n.transition(i,e.transitionDuration(),e.transitionDelay()).attr("transform","translate("+(e.margins().left+e.xAxisLength()/2)+","+(e.height()-Y)+")")},e._xAxisY=function(){return e.height()-e.margins().bottom},e.xAxisLength=function(){return e.effectiveWidth()},e.xAxisLabel=function(t,n){return arguments.length?(S=t,e.margins().bottom-=Y,Y=void 0===n?b:n,e.margins().bottom+=Y,e):S},e._prepareYAxis=function(n){if(void 0===R||e.elasticY()){void 0===R&&(R=t.scale.linear());var r=e.yAxisMin()||0,i=e.yAxisMax()||0;R.domain([r,i]).rangeRound([e.yAxisHeight(),0])}R.range([e.yAxisHeight(),0]),U=U.scale(R),ot&&U.orient("right"),e._renderHorizontalGridLinesForAxis(n,R,U)},e.renderYAxisLabel=function(t,r,i,a){a=a||V;var o=e.g().select("text."+m+"."+t+"-label"),l=e.margins().top+e.yAxisHeight()/2;o.empty()&&r&&(o=e.g().append("text").attr("transform","translate("+a+","+l+"),rotate("+i+")").attr("class",m+" "+t+"-label").attr("text-anchor","middle").text(r)),r&&o.text()!==r&&o.text(r),n.transition(o,e.transitionDuration(),e.transitionDelay()).attr("transform","translate("+a+","+l+"),rotate("+i+")")},e.renderYAxisAt=function(t,r,i){var a=e.g().select("g."+t);a.empty()&&(a=e.g().append("g").attr("class","axis "+t).attr("transform","translate("+i+","+e.margins().top+")")),n.transition(a,e.transitionDuration(),e.transitionDelay()).attr("transform","translate("+i+","+e.margins().top+")").call(r)},e.renderYAxis=function(){var t=ot?e.width()-e.margins().right:e._yAxisX();e.renderYAxisAt("y",U,t);var n=ot?e.width()-V:V,r=ot?90:-90;e.renderYAxisLabel("y",e.yAxisLabel(),r,n)},e._renderHorizontalGridLinesForAxis=function(t,r,i){var a=t.select("g."+y);if(K){var o=i.tickValues()?i.tickValues():r.ticks(i.ticks()[0]);a.empty()&&(a=t.insert("g",":first-child").attr("class",x+" "+y).attr("transform","translate("+e.margins().left+","+e.margins().top+")"));var l=a.selectAll("line").data(o),u=l.enter().append("line").attr("x1",1).attr("y1",function(t){return r(t)}).attr("x2",e.xAxisLength()).attr("y2",function(t){return r(t)}).attr("opacity",0);n.transition(u,e.transitionDuration(),e.transitionDelay()).attr("opacity",1),n.transition(l,e.transitionDuration(),e.transitionDelay()).attr("x1",1).attr("y1",function(t){return r(t)}).attr("x2",e.xAxisLength()).attr("y2",function(t){return r(t)}),l.exit().remove()}else a.selectAll("line").remove()},e._yAxisX=function(){return e.useRightYAxis()?e.width()-e.margins().right:e.margins().left},e.yAxisLabel=function(t,n){return arguments.length?(w=t,e.margins().left-=V,V=void 0===n?b:n,e.margins().left+=V,e):w},e.y=function(t){return arguments.length?(R=t,e.rescale(),e):R},e.yAxis=function(t){return arguments.length?(U=t,e):U},e.elasticY=function(t){return arguments.length?(z=t,e):z},e.renderHorizontalGridLines=function(t){return arguments.length?(K=t,e):K},e.renderVerticalGridLines=function(t){return arguments.length?(W=t,e):W},e.xAxisMin=function(){var r=t.min(e.data(),function(t){return e.keyAccessor()(t)});return n.utils.subtract(r,G,H)},e.xAxisMax=function(){var r=t.max(e.data(),function(t){return e.keyAccessor()(t)});return n.utils.add(r,G,H)},e.yAxisMin=function(){var r=t.min(e.data(),function(t){return e.valueAccessor()(t)});return n.utils.subtract(r,I)},e.yAxisMax=function(){var r=t.max(e.data(),function(t){return e.valueAccessor()(t)});return n.utils.add(r,I)},e.yAxisPadding=function(t){return arguments.length?(I=t,e):I},e.yAxisHeight=function(){return e.effectiveHeight()},e.round=function(t){return arguments.length?(E=t,e):E},e._rangeBandPadding=function(t){return arguments.length?(at=t,e):at},e._outerRangeBandPadding=function(t){return arguments.length?(it=t,e):it},n.override(e,"filter",function(t){return arguments.length?(e._filter(t),t?e.brush().extent(t):e.brush().clear(),e):e._filter()}),e.brush=function(t){return arguments.length?(X=t,e):X},e.renderBrush=function(t){if(q){X.on("brush",e._brushing),X.on("brushstart",e._disableMouseZoom),X.on("brushend",c);var n=t.append("g").attr("class","brush").attr("transform","translate("+e.margins().left+","+e.margins().top+")").call(X.x(e.x()));e.setBrushY(n,!1),e.setHandlePaths(n),e.hasFilter()&&e.redrawBrush(t,!1)}},e.setHandlePaths=function(t){t.selectAll(".resize").append("path").attr("d",e.resizeHandlePath)},e.setBrushY=function(t){t.selectAll("rect").attr("height",o()),t.selectAll(".resize path").attr("d",e.resizeHandlePath)},e.extendBrush=function(){var t=X.extent();return e.round()&&(t[0]=t.map(e.round())[0],t[1]=t.map(e.round())[1],D.select(".brush").call(X.extent(t))),t},e.brushIsEmpty=function(t){return X.empty()||!t||t[1]<=t[0]},e._brushing=function(){var t=e.extendBrush();if(e.redrawBrush(D,!1),e.brushIsEmpty(t))n.events.trigger(function(){e.filter(null),e.redrawGroup()},n.constants.EVENT_DELAY);else{var r=n.filters.RangedFilter(t[0],t[1]);n.events.trigger(function(){e.replaceFilter(r),e.redrawGroup()},n.constants.EVENT_DELAY)}},e.redrawBrush=function(t,r){if(q){e.filter()&&e.brush().empty()&&e.brush().extent(e.filter());var i=n.optionalTransition(r,e.transitionDuration(),e.transitionDelay())(t.select("g.brush"));e.setBrushY(i),i.call(e.brush().x(e.x()).extent(e.brush().extent()))}e.fadeDeselectedArea()},e.fadeDeselectedArea=function(){},e.resizeHandlePath=function(t){var e=+("e"===t),n=e?1:-1,r=o()/3;return"M"+.5*n+","+r+"A6,6 0 0 "+e+" "+6.5*n+","+(r+6)+"V"+(2*r-6)+"A6,6 0 0 "+e+" "+.5*n+","+2*r+"ZM"+2.5*n+","+(r+8)+"V"+(2*r-8)+"M"+4.5*n+","+(r+8)+"V"+(2*r-8)},e.clipPadding=function(t){return arguments.length?(rt=t,e):rt},e._preprocessData=function(){},e._doRender=function(){return e.resetSvg(),e._preprocessData(),e._generateG(),u(),s(!0),c(),e},e._doRedraw=function(){return e._preprocessData(),s(!1),u(),e},e._enableMouseZoom=function(){et=!0,$.x(e.x()).scaleExtent(J).size([e.width(),e.height()]).duration(e.transitionDuration()),e.root().call($)},e._disableMouseZoom=function(){e.root().call(tt)},e.focus=function(t){p(t)?e.x().domain(t):e.x().domain(L),$.x(e.x()),d()},e.refocused=function(){return j},e.focusChart=function(t){return arguments.length?(O=t,e.on("filtered",function(t){t.filter()?h(t.filter(),O.filter())||n.events.trigger(function(){O.focus(t.filter())}):n.events.trigger(function(){O.x().domain(O.xOriginalDomain())})}),e):O},e.brushOn=function(t){return arguments.length?(q=t,e):q},e},n.stackMixin=function(e){function r(t,n){var r=t.accessor||e.valueAccessor();return t.name=String(t.name||n),t.values=t.group.all().map(function(n,i){return{x:e.keyAccessor()(n,i),y:t.hidden?null:r(n,i),data:n,layer:t.name,hidden:t.hidden}}),t.values=t.values.filter(i()),t.values}function i(){if(!e.x())return t.functor(!0);var n=e.x().domain();return e.isOrdinal()?function(){return!0}:e.elasticX()?function(){return!0}:function(t){return t.x>=n[0]&&t.x<=n[n.length-1]}}function a(t){var e=s.map(n.pluck("name")).indexOf(t);return s[e]}function o(){var t=e.data().map(function(t){return t.values});return Array.prototype.concat.apply([],t)}function l(t){return!t.hidden}var u=t.layout.stack().values(r),s=[],c={},d=!1;return e.stack=function(t,n,r){if(!arguments.length)return s;arguments.length<=2&&(r=n);var i={group:t};return"string"==typeof n&&(i.name=n),"function"==typeof r&&(i.accessor=r),s.push(i),e},n.override(e,"group",function(t,n,r){return arguments.length?(s=[],c={},e.stack(t,n),r&&e.valueAccessor(r),e._group(t,n)):e._group()}),e.hidableStacks=function(t){return arguments.length?(d=t,e):d},e.hideStack=function(t){var n=a(t);return n&&(n.hidden=!0),e},e.showStack=function(t){var n=a(t);return n&&(n.hidden=!1),e},e.getValueAccessorByIndex=function(t){return s[t].accessor||e.valueAccessor()},e.yAxisMin=function(){var r=t.min(o(),function(t){return t.y<0?t.y+t.y0:t.y0});return n.utils.subtract(r,e.yAxisPadding())},e.yAxisMax=function(){var r=t.max(o(),function(t){return t.y>0?t.y+t.y0:t.y0});return n.utils.add(r,e.yAxisPadding())},e.xAxisMin=function(){var r=t.min(o(),n.pluck("x"));return n.utils.subtract(r,e.xAxisPadding(),e.xAxisPaddingUnit())},e.xAxisMax=function(){var r=t.max(o(),n.pluck("x"));return n.utils.add(r,e.xAxisPadding(),e.xAxisPaddingUnit())},n.override(e,"title",function(t,n){return t?"function"==typeof t?e._title(t):t===e._groupName&&"function"==typeof n?e._title(n):"function"!=typeof n?c[t]||e._title():(c[t]=n,e):e._title()}),e.stackLayout=function(n){return arguments.length?(u=n,u.values()===t.layout.stack().values()&&u.values(r),e):u},e.data(function(){var t=s.filter(l);return t.length?e.stackLayout()(t):[]}),e._ordinalXDomain=function(){var t=o().map(n.pluck("data")),r=e._computeOrderedGroups(t);return r.map(e.keyAccessor())},e.colorAccessor(function(t){var e=this.layer||this.name||t.name||t.layer;return e}),e.legendables=function(){return s.map(function(t,n){return{chart:e,name:t.name,hidden:t.hidden||!1,color:e.getColor.call(t,t.values,n)}})},e.isLegendableHidden=function(t){var e=a(t.name);return!!e&&e.hidden},e.legendToggle=function(t){d&&(e.isLegendableHidden(t)?e.showStack(t.name):e.hideStack(t.name),e.renderGroup())},e},n.capMixin=function(e){var r=1/0,i="Others",a=function(n){var r=t.sum(n,e.valueAccessor()),i=e.group().all(),a=t.sum(i,e.valueAccessor()),o=n.map(e.keyAccessor()),l=i.map(e.keyAccessor()),u=t.set(o),s=l.filter(function(t){return!u.has(t)});return a>r?n.concat([{others:s,key:e.othersLabel(),value:a-r}]):n};return e.cappedKeyAccessor=function(t,n){return t.others?t.key:e.keyAccessor()(t,n)},e.cappedValueAccessor=function(t,n){return t.others?t.value:e.valueAccessor()(t,n)},e.data(function(t){if(r===1/0)return e._computeOrderedGroups(t.all());var n=t.top(r);return n=e._computeOrderedGroups(n),a?a(n):n}),e.cap=function(t){return arguments.length?(r=t,e):r},e.othersLabel=function(t){return arguments.length?(i=t,e):i},e.othersGrouper=function(t){return arguments.length?(a=t,e):a},n.override(e,"onClick",function(t){t.others&&e.filter([t.others]),e._onClick(t)}),e},n.bubbleMixin=function(e){var r=.3,i=10;e.BUBBLE_NODE_CLASS="node",e.BUBBLE_CLASS="bubble",e.MIN_RADIUS=10,e=n.colorMixin(e),e.renderLabel(!0),e.data(function(t){return t.top(1/0)});var a=t.scale.linear().domain([0,100]),o=function(t){return t.r};e.r=function(t){return arguments.length?(a=t,e):a},e.radiusValueAccessor=function(t){return arguments.length?(o=t,e):o},e.rMin=function(){var n=t.min(e.data(),function(t){return e.radiusValueAccessor()(t)});return n},e.rMax=function(){var n=t.max(e.data(),function(t){return e.radiusValueAccessor()(t)});return n},e.bubbleR=function(t){var n=e.radiusValueAccessor()(t),r=e.r()(n);return(isNaN(r)||n<=0)&&(r=0),r};var l=function(t){return e.label()(t)},u=function(t){return e.bubbleR(t)>i},s=function(t){return u(t)?1:0},c=function(t){return u(t)?"all":"none"};e._doRenderLabel=function(t){if(e.renderLabel()){var r=t.select("text");r.empty()&&(r=t.append("text").attr("text-anchor","middle").attr("dy",".3em").on("click",e.onClick)),
r.attr("opacity",0).attr("pointer-events",c).text(l),n.transition(r,e.transitionDuration(),e.transitionDelay()).attr("opacity",s)}},e.doUpdateLabels=function(t){if(e.renderLabel()){var r=t.select("text").attr("pointer-events",c).text(l);n.transition(r,e.transitionDuration(),e.transitionDelay()).attr("opacity",s)}};var d=function(t){return e.title()(t)};return e._doRenderTitles=function(t){if(e.renderTitle()){var n=t.select("title");n.empty()&&t.append("title").text(d)}},e.doUpdateTitles=function(t){e.renderTitle()&&t.select("title").text(d)},e.minRadius=function(t){return arguments.length?(e.MIN_RADIUS=t,e):e.MIN_RADIUS},e.minRadiusWithLabel=function(t){return arguments.length?(i=t,e):i},e.maxBubbleRelativeSize=function(t){return arguments.length?(r=t,e):r},e.fadeDeselectedArea=function(){e.hasFilter()?e.selectAll("g."+e.BUBBLE_NODE_CLASS).each(function(t){e.isSelectedNode(t)?e.highlightSelected(this):e.fadeDeselected(this)}):e.selectAll("g."+e.BUBBLE_NODE_CLASS).each(function(){e.resetHighlight(this)})},e.isSelectedNode=function(t){return e.hasFilter(t.key)},e.onClick=function(t){var r=t.key;n.events.trigger(function(){e.filter(r),e.redrawGroup()})},e},n.pieChart=function(e,r){function i(){E=B?B:t.min([W.width(),W.height()])/2;var e,r=m(),i=b();if(t.sum(W.data(),W.valueAccessor())?(e=i(W.data()),T.classed(I,!1)):(e=i([{key:z,value:1,others:[z]}]),T.classed(I,!0)),T){var o=T.select("g."+Y).selectAll("g."+H).data(e),l=T.select("g."+U).selectAll("text."+P).data(e);a(o,l,r,e),g(e,r),y(o,l),v(),n.transition(T,W.transitionDuration(),W.transitionDelay()).attr("transform","translate("+W.cx()+","+W.cy()+")")}}function a(t,e,n,r){var i=o(t);l(i,n),u(i),d(e,r,n)}function o(t){var e=t.enter().append("g").attr("class",function(t,e){return H+" _"+e});return e}function l(t,e){var r=t.append("path").attr("fill",L).on("click",S).attr("d",function(t,n){return M(t,n,e)}),i=n.transition(r,W.transitionDuration(),W.transitionDelay());i.attrTween&&i.attrTween("d",k)}function u(t){W.renderTitle()&&t.append("title").text(function(t){return W.title()(t.data)})}function s(t,e){W._applyLabelText(t),n.transition(t,W.transitionDuration(),W.transitionDelay()).attr("transform",function(t){return R(t,e)}).attr("text-anchor","middle")}function c(t,e){W.select("g.pie-slice._"+t).classed("highlight",e)}function d(t,e,n){if(W.renderLabel()){var r=t.enter().append("text").attr("class",function(t,e){var n=H+" "+P+" _"+e;return F&&(n+=" external"),n}).on("click",S).on("mouseover",function(t,e){c(e,!0)}).on("mouseout",function(t,e){c(e,!1)});s(r,n),F&&K&&f(e,n)}}function f(e,r){var i=T.selectAll("polyline."+H).data(e);i.enter().append("polyline").attr("class",function(t,e){return"pie-path _"+e+" "+H}).on("click",S).on("mouseover",function(t,e){c(e,!0)}).on("mouseout",function(t,e){c(e,!1)}),i.exit().remove();var a=t.svg.arc().outerRadius(E-X+F).innerRadius(E-X),o=n.transition(i,W.transitionDuration(),W.transitionDelay());o.attrTween?o.attrTween("points",function(e){var n=this._current||e;n={startAngle:n.startAngle,endAngle:n.endAngle};var i=t.interpolate(n,e);return this._current=i(0),function(t){var e=i(t);return[r.centroid(e),a.centroid(e)]}}):o.attr("points",function(t){return[r.centroid(t),a.centroid(t)]}),o.style("visibility",function(t){return t.endAngle-t.startAngle<1e-4?"hidden":"visible"})}function g(t,e){h(t,e),p(t,e),x(t)}function h(t,e){var r=T.selectAll("g."+H).data(t).select("path").attr("d",function(t,n){return M(t,n,e)}),i=n.transition(r,W.transitionDuration(),W.transitionDelay());i.attrTween&&i.attrTween("d",k),i.attr("fill",L)}function p(t,e){if(W.renderLabel()){var n=T.selectAll("text."+P).data(t);s(n,e),F&&K&&f(t,e)}}function x(t){W.renderTitle()&&T.selectAll("g."+H).data(t).select("title").text(function(t){return W.title()(t.data)})}function y(t,e){t.exit().remove(),e.exit().remove()}function v(){W.hasFilter()?W.selectAll("g."+H).each(function(t){A(t)?W.highlightSelected(this):W.fadeDeselected(this)}):W.selectAll("g."+H).each(function(){W.resetHighlight(this)})}function m(){return t.svg.arc().outerRadius(E-X).innerRadius(V)}function A(t){return W.hasFilter(W.cappedKeyAccessor(t.data))}function b(){return t.layout.pie().sort(null).value(W.cappedValueAccessor)}function _(t){var e=t.endAngle-t.startAngle;return isNaN(e)||e<q}function D(t){return 0===W.cappedValueAccessor(t)}function k(e){e.innerRadius=V;var n=this._current;n=C(n)?{startAngle:0,endAngle:0}:{startAngle:n.startAngle,endAngle:n.endAngle};var r=t.interpolate(n,e);return this._current=r(0),function(t){return M(r(t),0,m())}}function C(t){return!t||isNaN(t.startAngle)||isNaN(t.endAngle)}function L(t,e){return W.getColor(t.data,e)}function S(t,e){T.attr("class")!==I&&W.onClick(t.data,e)}function M(t,e,n){var r=n(t,e);return r.indexOf("NaN")>=0&&(r="M0,0"),r}function R(e,n){var r;return r=F?t.svg.arc().outerRadius(E-X+F).innerRadius(E-X+F).centroid(e):n.centroid(e),isNaN(r[0])||isNaN(r[1])?"translate(0,0)":"translate("+r+")"}function w(e,n){W.selectAll("g.pie-slice").each(function(r){e.name===r.data.key&&t.select(this).classed("highlight",n)})}var E,B,T,O,N,F,G=.5,H="pie-slice",P="pie-label",Y="pie-slice-group",U="pie-label-group",I="empty-chart",z="empty",V=0,X=0,q=G,K=!1,W=n.capMixin(n.colorMixin(n.baseMixin({})));return W.colorAccessor(W.cappedKeyAccessor),W.title(function(t){return W.cappedKeyAccessor(t)+": "+W.cappedValueAccessor(t)}),W.slicesCap=W.cap,W.label(W.cappedKeyAccessor),W.renderLabel(!0),W.transitionDuration(350),W.transitionDelay(0),W._doRender=function(){return W.resetSvg(),T=W.svg().append("g").attr("transform","translate("+W.cx()+","+W.cy()+")"),T.append("g").attr("class",Y),T.append("g").attr("class",U),i(),W},W._applyLabelText=function(t){t.text(function(t){var e=t.data;return!D(e)&&!_(t)||A(t)?W.label()(t.data):""})},W.externalRadiusPadding=function(t){return arguments.length?(X=t,W):X},W.innerRadius=function(t){return arguments.length?(V=t,W):V},W.radius=function(t){return arguments.length?(B=t,W):B},W.cx=function(t){return arguments.length?(O=t,W):O||W.width()/2},W.cy=function(t){return arguments.length?(N=t,W):N||W.height()/2},W._doRedraw=function(){return i(),W},W.minAngleForLabel=function(t){return arguments.length?(q=t,W):q},W.emptyTitle=function(t){return 0===arguments.length?z:(z=t,W)},W.externalLabels=function(t){return 0===arguments.length?F:(F=t?t:void 0,W)},W.drawPaths=function(t){return 0===arguments.length?K:(K=t,W)},W.legendables=function(){return W.data().map(function(t,e){var n={name:t.key,data:t.value,others:t.others,chart:W};return n.color=W.getColor(t,e),n})},W.legendHighlight=function(t){w(t,!0)},W.legendReset=function(t){w(t,!1)},W.legendToggle=function(t){W.onClick({key:t.name,others:t.others})},W.anchor(e,r)},n.barChart=function(e,r){function i(t){return n.utils.safeNumber(Math.abs(g.y()(t.y+t.y0)-g.y()(t.y0)))}function a(t,e,r){var a=t.selectAll("text.barLabel").data(r.values,n.pluck("x"));a.enter().append("text").attr("class","barLabel").attr("text-anchor","middle"),g.isOrdinal()&&(a.on("click",g.onClick),a.attr("cursor","pointer")),n.transition(a,g.transitionDuration(),g.transitionDelay()).attr("x",function(t){var e=g.x()(t.x);return p||(e+=s/2),n.utils.safeNumber(e)}).attr("y",function(t){var e=g.y()(t.y+t.y0);return t.y<0&&(e-=i(t)),n.utils.safeNumber(e-f)}).text(function(t){return g.label()(t)}),n.transition(a.exit(),g.transitionDuration(),g.transitionDelay()).attr("height",0).remove()}function o(t,e,r){var a=t.selectAll("rect.bar").data(r.values,n.pluck("x")),o=a.enter().append("rect").attr("class","bar").attr("fill",n.pluck("data",g.getColor)).attr("y",g.yAxisHeight()).attr("height",0);g.renderTitle()&&o.append("title").text(n.pluck("data",g.title(r.name))),g.isOrdinal()&&a.on("click",g.onClick),n.transition(a,g.transitionDuration(),g.transitionDelay()).attr("x",function(t){var e=g.x()(t.x);return p&&(e-=s/2),g.isOrdinal()&&void 0!==h&&(e+=h/2),n.utils.safeNumber(e)}).attr("y",function(t){var e=g.y()(t.y+t.y0);return t.y<0&&(e-=i(t)),n.utils.safeNumber(e)}).attr("width",s).attr("height",function(t){return i(t)}).attr("fill",n.pluck("data",g.getColor)).select("title").text(n.pluck("data",g.title(r.name))),n.transition(a.exit(),g.transitionDuration(),g.transitionDelay()).attr("x",function(t){return g.x()(t.x)}).attr("width",.9*s).remove()}function l(){if(void 0===s){var t=g.xUnitCount();s=g.isOrdinal()&&void 0===h?Math.floor(g.x().rangeBand()):h?Math.floor((g.xAxisLength()-(t-1)*h)/t):Math.floor(g.xAxisLength()/(1+g.barPadding())/t),(s===1/0||isNaN(s)||s<c)&&(s=c)}}function u(e,n){return function(){var r=t.select(this),i=r.attr("fill")===e;return n?!i:i}}var s,c=1,d=2,f=3,g=n.stackMixin(n.coordinateGridMixin({})),h=d,p=!1,x=!1;return n.override(g,"rescale",function(){return g._rescale(),s=void 0,g}),n.override(g,"render",function(){return g.round()&&p&&!x&&n.logger.warn("By default, brush rounding is disabled if bars are centered. See dc.js bar chart API documentation for details."),g._render()}),g.label(function(t){return n.utils.printSingleValue(t.y0+t.y)},!1),g.plotData=function(){var e=g.chartBodyG().selectAll("g.stack").data(g.data());l(),e.enter().append("g").attr("class",function(t,e){return"stack _"+e});var n=e.size()-1;e.each(function(e,r){var i=t.select(this);o(i,r,e),g.renderLabel()&&n===r&&a(i,r,e)})},g.fadeDeselectedArea=function(){var t=g.chartBodyG().selectAll("rect.bar"),e=g.brush().extent();if(g.isOrdinal())g.hasFilter()?(t.classed(n.constants.SELECTED_CLASS,function(t){return g.hasFilter(t.x)}),t.classed(n.constants.DESELECTED_CLASS,function(t){return!g.hasFilter(t.x)})):(t.classed(n.constants.SELECTED_CLASS,!1),t.classed(n.constants.DESELECTED_CLASS,!1));else if(g.brushIsEmpty(e))t.classed(n.constants.DESELECTED_CLASS,!1);else{var r=e[0],i=e[1];t.classed(n.constants.DESELECTED_CLASS,function(t){return t.x<r||t.x>=i})}},g.centerBar=function(t){return arguments.length?(p=t,g):p},n.override(g,"onClick",function(t){g._onClick(t.data)}),g.barPadding=function(t){return arguments.length?(g._rangeBandPadding(t),h=void 0,g):g._rangeBandPadding()},g._useOuterPadding=function(){return void 0===h},g.outerPadding=g._outerRangeBandPadding,g.gap=function(t){return arguments.length?(h=t,g):h},g.extendBrush=function(){var t=g.brush().extent();return!g.round()||p&&!x||(t[0]=t.map(g.round())[0],t[1]=t.map(g.round())[1],g.chartBodyG().select(".brush").call(g.brush().extent(t))),t},g.alwaysUseRounding=function(t){return arguments.length?(x=t,g):x},g.legendHighlight=function(t){g.isLegendableHidden(t)||g.g().selectAll("rect.bar").classed("highlight",u(t.color)).classed("fadeout",u(t.color,!0))},g.legendReset=function(){g.g().selectAll("rect.bar").classed("highlight",!1).classed("fadeout",!1)},n.override(g,"xAxisMax",function(){var t=this._xAxisMax();if("resolution"in g.xUnits()){var e=g.xUnits().resolution;t+=e}return t}),g.anchor(e,r)},n.lineChart=function(e,r){function i(t,e){return S.getColor.call(t,t.values,e)}function a(e,r){var a=t.svg.line().x(function(t){return S.x()(t.x)}).y(function(t){return S.y()(t.y+t.y0)}).interpolate(T).tension(O);v&&a.defined(v);var o=e.append("path").attr("class","line").attr("stroke",i);m&&o.attr("stroke-dasharray",m),n.transition(r.select("path.line"),S.transitionDuration(),S.transitionDelay()).attr("stroke",i).attr("d",function(t){return l(a(t.values))})}function o(e,r){if(M){var a=t.svg.area().x(function(t){return S.x()(t.x)}).y(function(t){return S.y()(t.y+t.y0)}).y0(function(t){return S.y()(t.y0)}).interpolate(T).tension(O);v&&a.defined(v),e.append("path").attr("class","area").attr("fill",i).attr("d",function(t){return l(a(t.values))}),n.transition(r.select("path.area"),S.transitionDuration(),S.transitionDelay()).attr("fill",i).attr("d",function(t){return l(a(t.values))})}}function l(t){return!t||t.indexOf("NaN")>=0?"M0,0":t}function u(e,r){if("always"===S.xyTipsOn()||!S.brushOn()&&S.xyTipsOn()){var i=b+"-list",a=e.select("g."+i);a.empty()&&(a=e.append("g").attr("class",i)),r.each(function(e,r){var i=e.values;v&&(i=i.filter(v));var o=a.select("g."+b+"._"+r);o.empty()&&(o=a.append("g").attr("class",b+" _"+r)),c(o);var l=o.selectAll("circle."+_).data(i,n.pluck("x"));l.enter().append("circle").attr("class",_).attr("r",g()).style("fill-opacity",E).style("stroke-opacity",B).attr("fill",S.getColor).on("mousemove",function(){var e=t.select(this);d(e),f(e,o)}).on("mouseout",function(){var e=t.select(this);h(e),p(o)}),l.call(x,e),n.transition(l,S.transitionDuration()).attr("cx",function(t){return n.utils.safeNumber(S.x()(t.x))}).attr("cy",function(t){return n.utils.safeNumber(S.y()(t.y+t.y0))}).attr("fill",S.getColor),l.exit().remove()})}}function s(e){e.each(function(e,r){var i=t.select(this),a=i.selectAll("text.lineLabel").data(e.values,n.pluck("x"));a.enter().append("text").attr("class","lineLabel").attr("text-anchor","middle"),n.transition(a,S.transitionDuration()).attr("x",function(t){return n.utils.safeNumber(S.x()(t.x))}).attr("y",function(t){var e=S.y()(t.y+t.y0)-L;return n.utils.safeNumber(e)}).text(function(t){return S.label()(t)}),n.transition(a.exit(),S.transitionDuration()).attr("height",0).remove()})}function c(t){var e=t.select("path."+D).empty()?t.append("path").attr("class",D):t.select("path."+D);e.style("display","none").attr("stroke-dasharray","5,5");var n=t.select("path."+k).empty()?t.append("path").attr("class",k):t.select("path."+k);n.style("display","none").attr("stroke-dasharray","5,5")}function d(t){return t.style("fill-opacity",.8),t.style("stroke-opacity",.8),t.attr("r",R),t}function f(t,e){var n=t.attr("cx"),r=t.attr("cy"),i=S._yAxisX()-S.margins().left,a="M"+i+" "+r+"L"+n+" "+r,o="M"+n+" "+S.yAxisHeight()+"L"+n+" "+r;e.select("path."+D).style("display","").attr("d",a),e.select("path."+k).style("display","").attr("d",o)}function g(){return w||R}function h(t){t.style("fill-opacity",E).style("stroke-opacity",B).attr("r",g())}function p(t){t.select("path."+D).style("display","none"),t.select("path."+k).style("display","none")}function x(t,e){S.renderTitle()&&(t.select("title").remove(),t.append("title").text(n.pluck("data",S.title(e.name))))}function y(e,n,r){return function(){var i=t.select(this),a=i.attr("stroke")===e&&i.attr("stroke-dasharray")===(n instanceof Array?n.join(","):null)||i.attr("fill")===e;return r?!a:a}}var v,m,A=5,b="dc-tooltip",_="dot",D="yRef",k="xRef",C=1e-6,L=3,S=n.stackMixin(n.coordinateGridMixin({})),M=!1,R=A,w=null,E=C,B=C,T="linear",O=.7,N=!0;return S.transitionDuration(500),S.transitionDelay(0),S._rangeBandPadding(1),S.plotData=function(){var t=S.chartBodyG(),e=t.select("g.stack-list");e.empty()&&(e=t.append("g").attr("class","stack-list"));var n=e.selectAll("g.stack").data(S.data()),r=n.enter().append("g").attr("class",function(t,e){return"stack _"+e});a(r,n),o(r,n),u(t,n),S.renderLabel()&&s(n)},S.interpolate=function(t){return arguments.length?(T=t,S):T},S.tension=function(t){return arguments.length?(O=t,S):O},S.defined=function(t){return arguments.length?(v=t,S):v},S.dashStyle=function(t){return arguments.length?(m=t,S):m},S.renderArea=function(t){return arguments.length?(M=t,S):M},S.label(function(t){return n.utils.printSingleValue(t.y0+t.y)},!1),S.xyTipsOn=function(t){return arguments.length?(N=t,S):N},S.dotRadius=function(t){return arguments.length?(R=t,S):R},S.renderDataPoints=function(t){return arguments.length?(t?(E=t.fillOpacity||.8,B=t.strokeOpacity||.8,w=t.radius||2):(E=C,B=C,w=null),S):{fillOpacity:E,strokeOpacity:B,radius:w}},S.legendHighlight=function(t){S.isLegendableHidden(t)||S.g().selectAll("path.line, path.area").classed("highlight",y(t.color,t.dashstyle)).classed("fadeout",y(t.color,t.dashstyle,!0))},S.legendReset=function(){S.g().selectAll("path.line, path.area").classed("highlight",!1).classed("fadeout",!1)},n.override(S,"legendables",function(){var t=S._legendables();return m?t.map(function(t){return t.dashstyle=m,t}):t}),S.anchor(e,r)},n.dataCount=function(e,r){var i=t.format(",d"),a=n.baseMixin({}),o={some:"",all:""};return a.html=function(t){return arguments.length?(t.all&&(o.all=t.all),t.some&&(o.some=t.some),a):o},a.formatNumber=function(t){return arguments.length?(i=t,a):i},a._doRender=function(){var t=a.dimension().size(),e=a.group().value(),n=i(t),r=i(e);return t===e&&""!==o.all?a.root().html(o.all.replace("%total-count",n).replace("%filter-count",r)):""!==o.some?a.root().html(o.some.replace("%total-count",n).replace("%filter-count",r)):(a.selectAll(".total-count").text(n),a.selectAll(".filter-count").text(r)),a},a._doRedraw=function(){return a._doRender()},a.anchor(e,r)},n.dataTable=function(e,r){function i(){var t=!0;if(p.forEach(function(e){t&="function"==typeof e}),!t){var e=g.selectAll("thead").data([0]);e.enter().append("thead"),e.exit().remove();var n=e.selectAll("tr").data([0]);n.enter().append("tr"),n.exit().remove();var r=n.selectAll("th").data(p);r.enter().append("th"),r.exit().remove(),r.attr("class",f).html(function(t){return g._doColumnHeaderFormat(t)})}var i=g.root().selectAll("tbody").data(a(),function(t){return g.keyAccessor()(t)}),o=i.enter().append("tbody");return m===!0&&o.append("tr").attr("class",d).append("td").attr("class",u).attr("colspan",p.length).html(function(t){return g.keyAccessor()(t)}),i.exit().remove(),o}function a(){var e;return e=y===t.ascending?g.dimension().bottom(h):g.dimension().top(h),t.nest().key(g.group()).sortKeys(y).entries(e.sort(function(t,e){return y(x(t),x(e))}).slice(v,l))}function o(t){var e=t.order().selectAll("tr."+s).data(function(t){return t.values}),n=e.enter().append("tr").attr("class",s);return p.forEach(function(t,e){n.append("td").attr("class",c+" _"+e).html(function(e){return g._doColumnValueFormat(t,e)})}),e.exit().remove(),e}var l,u="dc-table-label",s="dc-table-row",c="dc-table-column",d="dc-table-group",f="dc-table-head",g=n.baseMixin({}),h=25,p=[],x=function(t){return t},y=t.ascending,v=0,m=!0;return g._doRender=function(){return g.selectAll("tbody").remove(),o(i()),g},g._doColumnValueFormat=function(t,e){return"function"==typeof t?t(e):"string"==typeof t?e[t]:t.format(e)},g._doColumnHeaderFormat=function(t){return"function"==typeof t?g._doColumnHeaderFnToString(t):"string"==typeof t?g._doColumnHeaderCapitalize(t):String(t.label)},g._doColumnHeaderCapitalize=function(t){return t.charAt(0).toUpperCase()+t.slice(1)},g._doColumnHeaderFnToString=function(t){var e=String(t),n=e.indexOf("return ");if(n>=0){var r=e.lastIndexOf(";");if(r>=0){e=e.substring(n+7,r);var i=e.indexOf("numberFormat");i>=0&&(e=e.replace("numberFormat",""))}}return e},g._doRedraw=function(){return g._doRender()},g.size=function(t){return arguments.length?(h=t,g):h},g.beginSlice=function(t){return arguments.length?(v=t,g):v},g.endSlice=function(t){return arguments.length?(l=t,g):l},g.columns=function(t){return arguments.length?(p=t,g):p},g.sortBy=function(t){return arguments.length?(x=t,g):x},g.order=function(t){return arguments.length?(y=t,g):y},g.showGroups=function(t){return arguments.length?(m=t,g):m},g.anchor(e,r)},n.dataGrid=function(e,r){function i(){var t=f.root().selectAll("div."+d).data(a(),function(t){return f.keyAccessor()(t)}),e=t.enter().append("div").attr("class",d);return v&&e.html(function(t){return v(t)}),t.exit().remove(),e}function a(){var e=f.dimension().top(g);return t.nest().key(f.group()).sortKeys(x).entries(e.sort(function(t,e){return x(p(t),p(e))}).slice(y,l))}function o(t){var e=t.order().selectAll("div."+s).data(function(t){return t.values});return e.enter().append("div").attr("class",s).html(function(t){return h(t)}),e.exit().remove(),e}var l,u="dc-grid-label",s="dc-grid-item",c="dc-grid-group",d="dc-grid-top",f=n.baseMixin({}),g=999,h=function(t){return"you need to provide an html() handling param:  "+JSON.stringify(t)},p=function(t){return t},x=t.ascending,y=0,v=function(t){return"<div class='"+c+"'><h1 class='"+u+"'>"+f.keyAccessor()(t)+"</h1></div>"};return f._doRender=function(){return f.selectAll("div."+d).remove(),o(i()),f},f._doRedraw=function(){return f._doRender()},f.beginSlice=function(t){return arguments.length?(y=t,f):y},f.endSlice=function(t){return arguments.length?(l=t,f):l},f.size=function(t){return arguments.length?(g=t,f):g},f.html=function(t){return arguments.length?(h=t,f):h},f.htmlGroup=function(t){return arguments.length?(v=t,f):v},f.sortBy=function(t){return arguments.length?(p=t,f):p},f.order=function(t){return arguments.length?(x=t,f):x},f.anchor(e,r)},n.bubbleChart=function(e,r){function i(t){var e=t.enter().append("g");e.attr("class",s.BUBBLE_NODE_CLASS).attr("transform",f).append("circle").attr("class",function(t,e){return s.BUBBLE_CLASS+" _"+e}).on("click",s.onClick).attr("fill",s.getColor).attr("r",0),n.transition(t,s.transitionDuration(),s.transitionDelay()).select("circle."+s.BUBBLE_CLASS).attr("r",function(t){return s.bubbleR(t)}).attr("opacity",function(t){return s.bubbleR(t)>0?1:0}),s._doRenderLabel(e),s._doRenderTitles(e)}function a(t){n.transition(t,s.transitionDuration(),s.transitionDelay()).attr("transform",f).select("circle."+s.BUBBLE_CLASS).attr("fill",s.getColor).attr("r",function(t){return s.bubbleR(t)}).attr("opacity",function(t){return s.bubbleR(t)>0?1:0}),s.doUpdateLabels(t),s.doUpdateTitles(t)}function o(t){t.exit().remove()}function l(t){var e=s.x()(s.keyAccessor()(t));return isNaN(e)&&(e=0),e}function u(t){var e=s.y()(s.valueAccessor()(t));return isNaN(e)&&(e=0),e}var s=n.bubbleMixin(n.coordinateGridMixin({})),c=!1,d=!1;s.transitionDuration(750),s.transitionDelay(0);var f=function(t){return"translate("+l(t)+","+u(t)+")"};return s.elasticRadius=function(t){return arguments.length?(c=t,s):c},s.sortBubbleSize=function(t){return arguments.length?(d=t,s):d},s.plotData=function(){c&&s.r().domain([s.rMin(),s.rMax()]),s.r().range([s.MIN_RADIUS,s.xAxisLength()*s.maxBubbleRelativeSize()]);var e=s.data();if(d){var n=s.radiusValueAccessor();e.sort(function(e,r){return t.descending(n(e),n(r))})}var r=s.chartBodyG().selectAll("g."+s.BUBBLE_NODE_CLASS).data(e,function(t){return t.key});d&&r.order(),i(r),a(r),o(r),s.fadeDeselectedArea()},s.renderBrush=function(){},s.redrawBrush=function(){s.fadeDeselectedArea()},s.anchor(e,r)},n.compositeChart=function(e,r){function i(t,e){var n,r,i,o,l;return t&&(n=f(),r=p()),e&&(i=g(),o=x()),_.alignYAxes()&&t&&e&&(l=a(n,r,i,o)),l||{lyAxisMin:n,lyAxisMax:r,ryAxisMin:i,ryAxisMax:o}}function a(t,e,n,r){var i=(r-n)/(e-t);return{lyAxisMin:Math.min(t,n/i),lyAxisMax:Math.max(e,r/i),ryAxisMin:Math.min(n,t*i),ryAxisMax:Math.max(r,e*i)}}function o(e){var n=void 0===_.rightY()||_.elasticY(),r=n||_.resizing();void 0===_.rightY()&&_.rightY(t.scale.linear()),n&&_.rightY().domain([e.ryAxisMin,e.ryAxisMax]),r&&_.rightY().rangeRound([_.yAxisHeight(),0]),_.rightY().range([_.yAxisHeight(),0]),_.rightYAxis(_.rightYAxis().scale(_.rightY())),_.rightYAxis().orient("right")}function l(e){var n=void 0===_.y()||_.elasticY(),r=n||_.resizing();void 0===_.y()&&_.y(t.scale.linear()),n&&_.y().domain([e.lyAxisMin,e.lyAxisMax]),r&&_.y().rangeRound([_.yAxisHeight(),0]),_.y().range([_.yAxisHeight(),0]),_.yAxis(_.yAxis().scale(_.y())),_.yAxis().orient("left")}function u(t,e){t._generateG(_.g()),t.g().attr("class",A+" _"+e)}function s(){return D.filter(function(t){return!t.useRightYAxis()})}function c(){return D.filter(function(t){return t.useRightYAxis()})}function d(t){return t.map(function(t){return t.yAxisMin()})}function f(){return t.min(d(s()))}function g(){return t.min(d(c()))}function h(t){return t.map(function(t){return t.yAxisMax()})}function p(){return n.utils.add(t.max(h(s())),_.yAxisPadding())}function x(){return n.utils.add(t.max(h(c())),_.yAxisPadding())}function y(){return D.map(function(t){return t.xAxisMin()})}function v(){return D.map(function(t){return t.xAxisMax()})}var m,A="sub",b=12,_=n.coordinateGridMixin({}),D=[],k={},C=!1,L=!0,S=!1,M=t.svg.axis(),R=0,w=b,E=!1;return _._mandatoryAttributes([]),_.transitionDuration(500),_.transitionDelay(0),n.override(_,"_generateG",function(){for(var t=this.__generateG(),e=0;e<D.length;++e){var n=D[e];u(n,e),n.dimension()||n.dimension(_.dimension()),n.group()||n.group(_.group()),n.chartGroup(_.chartGroup()),n.svg(_.svg()),n.xUnits(_.xUnits()),n.transitionDuration(_.transitionDuration(),_.transitionDelay()),n.brushOn(_.brushOn()),n.renderTitle(_.renderTitle()),n.elasticX(_.elasticX())}return t}),_._brushing=function(){for(var t=_.extendBrush(),e=_.brushIsEmpty(t),n=0;n<D.length;++n)D[n].replaceFilter(e?null:t)},_._prepareYAxis=function(){var t=0!==s().length,e=0!==c().length,n=i(t,e);t&&l(n),e&&o(n),s().length>0&&!E?_._renderHorizontalGridLinesForAxis(_.g(),_.y(),_.yAxis()):c().length>0&&_._renderHorizontalGridLinesForAxis(_.g(),m,M)},_.renderYAxis=function(){0!==s().length&&(_.renderYAxisAt("y",_.yAxis(),_.margins().left),_.renderYAxisLabel("y",_.yAxisLabel(),-90)),0!==c().length&&(_.renderYAxisAt("yr",_.rightYAxis(),_.width()-_.margins().right),_.renderYAxisLabel("yr",_.rightYAxisLabel(),90,_.width()-w))},_.plotData=function(){for(var t=0;t<D.length;++t){var e=D[t];e.g()||u(e,t),C&&e.colors(_.colors()),e.x(_.x()),e.xAxis(_.xAxis()),e.useRightYAxis()?(e.y(_.rightY()),e.yAxis(_.rightYAxis())):(e.y(_.y()),e.yAxis(_.yAxis())),e.plotData(),e._activateRenderlets()}},_.useRightAxisGridLines=function(t){return arguments?(E=t,_):E},_.childOptions=function(t){return arguments.length?(k=t,D.forEach(function(t){t.options(k)}),_):k},_.fadeDeselectedArea=function(){for(var t=0;t<D.length;++t){var e=D[t];e.brush(_.brush()),e.fadeDeselectedArea()}},_.rightYAxisLabel=function(t,e){return arguments.length?(R=t,_.margins().right-=w,w=void 0===e?b:e,_.margins().right+=w,_):R},_.compose=function(t){return D=t,D.forEach(function(t){t.height(_.height()),t.width(_.width()),t.margins(_.margins()),L&&t.title(_.title()),t.options(k)}),_},_.children=function(){return D},_.shareColors=function(t){return arguments.length?(C=t,_):C},_.shareTitle=function(t){return arguments.length?(L=t,_):L},_.rightY=function(t){return arguments.length?(m=t,_.rescale(),_):m},_.alignYAxes=function(t){return arguments.length?(S=t,_.rescale(),_):S},delete _.yAxisMin,delete _.yAxisMax,n.override(_,"xAxisMin",function(){return n.utils.subtract(t.min(y()),_.xAxisPadding())}),n.override(_,"xAxisMax",function(){return n.utils.add(t.max(v()),_.xAxisPadding())}),_.legendables=function(){return D.reduce(function(t,e){return C&&e.colors(_.colors()),t.push.apply(t,e.legendables()),t},[])},_.legendHighlight=function(t){for(var e=0;e<D.length;++e){var n=D[e];n.legendHighlight(t)}},_.legendReset=function(t){for(var e=0;e<D.length;++e){var n=D[e];n.legendReset(t)}},_.legendToggle=function(){console.log("composite should not be getting legendToggle itself")},_.rightYAxis=function(t){return arguments.length?(M=t,_):M},_.anchor(e,r)},n.seriesChart=function(e,r){function i(e,n){return t.ascending(u.keyAccessor()(e),u.keyAccessor()(n))}function a(t){s[t].g()&&s[t].g().remove(),delete s[t]}function o(){Object.keys(s).map(a),s={}}var l,u=n.compositeChart(e,r),s={},c=n.lineChart,d=t.ascending,f=i;return u._mandatoryAttributes().push("seriesAccessor","chart"),u.shareColors(!0),u._preprocessData=function(){var e,n=[],i=t.nest().key(l);d&&i.sortKeys(d),f&&i.sortValues(f);var o=i.entries(u.data()),g=o.map(function(i,a){var o=s[i.key]||c.call(u,u,r,i.key,a);return s[i.key]||(e=!0),s[i.key]=o,n.push(i.key),o.dimension(u.dimension()).group({all:t.functor(i.values)},i.key).keyAccessor(u.keyAccessor()).valueAccessor(u.valueAccessor()).brushOn(u.brushOn())});Object.keys(s).filter(function(t){return n.indexOf(t)===-1}).forEach(function(t){a(t),e=!0}),u._compose(g),e&&u.legend()&&u.legend().render()},u.chart=function(t){return arguments.length?(c=t,o(),u):c},u.seriesAccessor=function(t){return arguments.length?(l=t,o(),u):l},u.seriesSort=function(t){return arguments.length?(d=t,o(),u):d},u.valueSort=function(t){return arguments.length?(f=t,o(),u):f},u._compose=u.compose,delete u.compose,u},n.geoChoroplethChart=function(e,r){function i(t){var e=a();if(o(t)){var n=l(t);g(n,t,e),h(n,t,e)}}function a(){for(var t={},e=p.data(),n=0;n<e.length;++n)t[p.keyAccessor()(e[n])]=p.valueAccessor()(e[n]);return t}function o(t){return f(t).keyAccessor}function l(t){var e=p.svg().selectAll(u(t)).classed("selected",function(e){return s(t,e)}).classed("deselected",function(e){return c(t,e)}).attr("class",function(e){var r=f(t).name,i=n.utils.nameToId(f(t).keyAccessor(e)),a=r+" "+i;return s(t,e)&&(a+=" selected"),c(t,e)&&(a+=" deselected"),a});return e}function u(t){return"g.layer"+t+" g."+f(t).name}function s(t,e){return p.hasFilter()&&p.hasFilter(d(t,e))}function c(t,e){return p.hasFilter()&&!p.hasFilter(d(t,e))}function d(t,e){return f(t).keyAccessor(e)}function f(t){return v[t]}function g(e,r,i){var a=e.select("path").attr("fill",function(){var e=t.select(this).attr("fill");return e?e:"none"}).on("click",function(t){return p.onClick(t,r)});n.transition(a,p.transitionDuration(),p.transitionDelay()).attr("fill",function(t,e){return p.getColor(i[f(r).keyAccessor(t)],e)})}function h(t,e,n){p.renderTitle()&&t.selectAll("title").text(function(t){var r=d(e,t),i=n[r];return p.title()({key:r,value:i})})}var p=n.colorMixin(n.baseMixin({}));p.colorAccessor(function(t){return t||0});var x,y=t.geo.path(),v=[];return p._doRender=function(){p.resetSvg();for(var t=0;t<v.length;++t){var e=p.svg().append("g").attr("class","layer"+t),n=e.selectAll("g."+f(t).name).data(f(t).data).enter().append("g").attr("class",f(t).name);n.append("path").attr("fill","white").attr("d",y),n.append("title"),i(t)}x=!1},p.onClick=function(t,e){var r=f(e).keyAccessor(t);n.events.trigger(function(){p.filter(r),p.redrawGroup()})},p._doRedraw=function(){for(var t=0;t<v.length;++t)i(t),x&&p.svg().selectAll("g."+f(t).name+" path").attr("d",y);x=!1},p.overlayGeoJson=function(t,e,n){for(var r=0;r<v.length;++r)if(v[r].name===e)return v[r].data=t,v[r].keyAccessor=n,p;return v.push({name:e,data:t,keyAccessor:n}),p},p.projection=function(t){return y.projection(t),x=!0,p},p.geoJsons=function(){return v},p.geoPath=function(){return y},p.removeGeoJson=function(t){for(var e=[],n=0;n<v.length;++n){var r=v[n];r.name!==t&&e.push(r)}return v=e,p},p.anchor(e,r)},n.bubbleOverlay=function(e,r){function i(){return s=g.select("g."+c),s.empty()&&(s=g.svg().append("g").attr("class",c)),s}function a(){var t=o();h.forEach(function(e){var r=l(e,t),i=r.select("circle."+f);i.empty()&&(i=r.append("circle").attr("class",f).attr("r",0).attr("fill",g.getColor).on("click",g.onClick)),n.transition(i,g.transitionDuration(),g.transitionDelay()).attr("r",function(t){return g.bubbleR(t)}),g._doRenderLabel(r),g._doRenderTitles(r)})}function o(){var t={};return g.data().forEach(function(e){t[g.keyAccessor()(e)]=e}),t}function l(t,e){var r=d+" "+n.utils.nameToId(t.name),i=s.select("g."+n.utils.nameToId(t.name));return i.empty()&&(i=s.append("g").attr("class",r).attr("transform","translate("+t.x+","+t.y+")")),i.datum(e[t.name]),i}function u(){var t=o();h.forEach(function(e){var r=l(e,t),i=r.select("circle."+f);n.transition(i,g.transitionDuration(),g.transitionDelay()).attr("r",function(t){return g.bubbleR(t)}).attr("fill",g.getColor),g.doUpdateLabels(r),g.doUpdateTitles(r)})}var s,c="bubble-overlay",d="node",f="bubble",g=n.bubbleMixin(n.baseMixin({})),h=[];return g.transitionDuration(750),g.transitionDelay(0),g.radiusValueAccessor(function(t){return t.value}),g.point=function(t,e,n){return h.push({name:t,x:e,y:n}),g},g._doRender=function(){return s=i(),g.r().range([g.MIN_RADIUS,g.width()*g.maxBubbleRelativeSize()]),a(),g.fadeDeselectedArea(),g},g._doRedraw=function(){return u(),g.fadeDeselectedArea(),g},g.debug=function(e){if(e){var r=g.select("g."+n.constants.DEBUG_GROUP_CLASS);r.empty()&&(r=g.svg().append("g").attr("class",n.constants.DEBUG_GROUP_CLASS));var i=r.append("text").attr("x",10).attr("y",20);r.append("rect").attr("width",g.width()).attr("height",g.height()).on("mousemove",function(){var e=t.mouse(r.node()),n=e[0]+", "+e[1];i.text(n)})}else g.selectAll(".debug").remove();return g},g.anchor(e,r),g},n.rowChart=function(e,r){function i(){if(!m||A){var e=t.extent(b,B.cappedValueAccessor);e[0]>0&&(e[0]=0),e[1]<0&&(e[1]=0),
m=t.scale.linear().domain(e).range([0,B.effectiveWidth()])}T.scale(m)}function a(){var t=v.select("g.axis");i(),t.empty()&&(t=v.append("g").attr("class","axis")),t.attr("transform","translate(0, "+B.effectiveHeight()+")"),n.transition(t,B.transitionDuration(),B.transitionDelay()).call(T)}function o(){v.selectAll("g.tick").select("line.grid-line").remove(),v.selectAll("g.tick").append("line").attr("class","grid-line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",function(){return-B.effectiveHeight()})}function l(){b=B.data(),a(),o();var t=v.selectAll("g."+R).data(b);u(t),s(t),d(t)}function u(t){var e=t.enter().append("g").attr("class",function(t,e){return R+" _"+e});e.append("rect").attr("width",0),g(e)}function s(t){t.exit().remove()}function c(){var t=m(0);return t===-(1/0)||t!==t?m(1):t}function d(t){var e,r=b.length;e=M?M:(B.effectiveHeight()-(r+1)*S)/r,k||(D=e/2);var i=t.attr("transform",function(t,n){return"translate(0,"+((n+1)*S+n*e)+")"}).select("rect").attr("height",e).attr("fill",B.getColor).on("click",p).classed("deselected",function(t){return!!B.hasFilter()&&!y(t)}).classed("selected",function(t){return!!B.hasFilter()&&y(t)});n.transition(i,B.transitionDuration(),B.transitionDelay()).attr("width",function(t){return Math.abs(c()-m(B.valueAccessor()(t)))}).attr("transform",x),f(t),h(t)}function f(t){B.renderTitle()&&(t.select("title").remove(),t.append("title").text(B.title()))}function g(t){B.renderLabel()&&t.append("text").on("click",p),B.renderTitleLabel()&&t.append("text").attr("class",w).on("click",p)}function h(t){if(B.renderLabel()){var e=t.select("text").attr("x",_).attr("y",D).attr("dy",C).on("click",p).attr("class",function(t,e){return R+" _"+e}).text(function(t){return B.label()(t)});n.transition(e,B.transitionDuration(),B.transitionDelay()).attr("transform",x)}if(B.renderTitleLabel()){var r=t.select("."+w).attr("x",B.effectiveWidth()-L).attr("y",D).attr("dy",C).attr("text-anchor","end").on("click",p).attr("class",function(t,e){return w+" _"+e}).text(function(t){return B.title()(t)});n.transition(r,B.transitionDuration(),B.transitionDelay()).attr("transform",x)}}function p(t){B.onClick(t)}function x(t){var e=m(B.cappedValueAccessor(t)),n=c(),r=e>n?n:e;return"translate("+r+",0)"}function y(t){return B.hasFilter(B.cappedKeyAccessor(t))}var v,m,A,b,_=10,D=15,k=!1,C="0.35em",L=2,S=5,M=!1,R="row",w="titlerow",E=!1,B=n.capMixin(n.marginMixin(n.colorMixin(n.baseMixin({})))),T=t.svg.axis().orient("bottom");return B.rowsCap=B.cap,B._doRender=function(){return B.resetSvg(),v=B.svg().append("g").attr("transform","translate("+B.margins().left+","+B.margins().top+")"),l(),B},B.title(function(t){return B.cappedKeyAccessor(t)+": "+B.cappedValueAccessor(t)}),B.label(B.cappedKeyAccessor),B.x=function(t){return arguments.length?(m=t,B):m},B.renderTitleLabel=function(t){return arguments.length?(E=t,B):E},B._doRedraw=function(){return l(),B},B.xAxis=function(){return T},B.fixedBarHeight=function(t){return arguments.length?(M=t,B):M},B.gap=function(t){return arguments.length?(S=t,B):S},B.elasticX=function(t){return arguments.length?(A=t,B):A},B.labelOffsetX=function(t){return arguments.length?(_=t,B):_},B.labelOffsetY=function(t){return arguments.length?(D=t,k=!0,B):D},B.titleLabelOffsetX=function(t){return arguments.length?(L=t,B):L},B.anchor(e,r)},n.legend=function(){function t(){return c+s}var e,r,i,a=2,o={},l=0,u=0,s=12,c=5,d=!1,f=560,g=70,h=!1,p=n.pluck("name");return o.parent=function(t){return arguments.length?(e=t,o):e},o.render=function(){e.svg().select("g.dc-legend").remove(),i=e.svg().append("g").attr("class","dc-legend").attr("transform","translate("+l+","+u+")");var o=e.legendables();void 0!==r&&(o=o.slice(0,r));var x=i.selectAll("g.dc-legend-item").data(o).enter().append("g").attr("class","dc-legend-item").on("mouseover",function(t){e.legendHighlight(t)}).on("mouseout",function(t){e.legendReset(t)}).on("click",function(t){t.chart.legendToggle(t)});i.selectAll("g.dc-legend-item").classed("fadeout",function(t){return t.chart.isLegendableHidden(t)}),o.some(n.pluck("dashstyle"))?x.append("line").attr("x1",0).attr("y1",s/2).attr("x2",s).attr("y2",s/2).attr("stroke-width",2).attr("stroke-dasharray",n.pluck("dashstyle")).attr("stroke",n.pluck("color")):x.append("rect").attr("width",s).attr("height",s).attr("fill",function(t){return t?t.color:"blue"}),x.append("text").text(p).attr("x",s+a).attr("y",function(){return s/2+(this.clientHeight?this.clientHeight:13)/2-2});var y=0,v=0;x.attr("transform",function(e,n){if(d){var r=h===!0?this.getBBox().width+c:g;y+r>f&&y>0&&(++v,y=0);var i="translate("+y+","+v*t()+")";return y+=r,i}return"translate(0,"+n*t()+")"})},o.x=function(t){return arguments.length?(l=t,o):l},o.y=function(t){return arguments.length?(u=t,o):u},o.gap=function(t){return arguments.length?(c=t,o):c},o.itemHeight=function(t){return arguments.length?(s=t,o):s},o.horizontal=function(t){return arguments.length?(d=t,o):d},o.legendWidth=function(t){return arguments.length?(f=t,o):f},o.itemWidth=function(t){return arguments.length?(g=t,o):g},o.autoItemWidth=function(t){return arguments.length?(h=t,o):h},o.legendText=function(t){return arguments.length?(p=t,o):p},o.maxItems=function(t){return arguments.length?(r=n.utils.isNumber(t)?t:void 0,o):r},o},n.scatterPlot=function(e,r){function i(t,e){o.renderTitle()&&(t.selectAll("title").remove(),t.append("title").text(function(t){return o.title()(t)}))}function a(e,r){var i=o.selectAll(".chart-body path.symbol").filter(function(){return e(t.select(this))}),a=l.size();l.size(Math.pow(r,2)),n.transition(i,o.transitionDuration(),o.transitionDelay()).attr("d",l),l.size(a)}var o=n.coordinateGridMixin({}),l=t.svg.symbol(),u=function(t){return t.value},s=o.keyAccessor();o.keyAccessor(function(t){return s(t)[0]}),o.valueAccessor(function(t){return s(t)[1]}),o.colorAccessor(function(){return o._groupName}),o.title(function(t){return o.keyAccessor()(t)+","+o.valueAccessor()(t)+": "+o.existenceAccessor()(t)});var c=function(t){return"translate("+o.x()(o.keyAccessor()(t))+","+o.y()(o.valueAccessor()(t))+")"},d=7,f=5,g=3,h=null,p=1,x=0,y=0,v=1,m=null,A=[];return l.size(function(t,e){return u(t)?A[e]?Math.pow(f,2):Math.pow(g,2):Math.pow(x,2)}),n.override(o,"_filter",function(t){return arguments.length?o.__filter(n.filters.RangedTwoDimensionalFilter(t)):o.__filter()}),o.plotData=function(){var t=o.chartBodyG().selectAll("path.symbol").data(o.data());t.enter().append("path").attr("class","symbol").attr("opacity",0).attr("fill",o.getColor).attr("transform",c),t.call(i,o.data()),t.each(function(t,e){A[e]=!o.filter()||o.filter().isFiltered([t.key[0],t.key[1]])}),n.transition(t,o.transitionDuration(),o.transitionDelay()).attr("opacity",function(t,e){return u(t)?A[e]?v:o.excludedOpacity():y}).attr("fill",function(t,e){return m&&!u(t)?m:o.excludedColor()&&!A[e]?o.excludedColor():o.getColor(t)}).attr("transform",c).attr("d",l),n.transition(t.exit(),o.transitionDuration(),o.transitionDelay()).attr("opacity",0).remove()},o.existenceAccessor=function(t){return arguments.length?(u=t,this):u},o.symbol=function(t){return arguments.length?(l.type(t),o):l.type()},o.symbolSize=function(t){return arguments.length?(f=t,o):f},o.highlightedSize=function(t){return arguments.length?(d=t,o):d},o.excludedSize=function(t){return arguments.length?(g=t,o):g},o.excludedColor=function(t){return arguments.length?(h=t,o):h},o.excludedOpacity=function(t){return arguments.length?(p=t,o):p},o.hiddenSize=o.emptySize=function(t){return arguments.length?(x=t,o):x},o.emptyColor=function(t){return arguments.length?(m=t,o):m},o.emptyOpacity=function(t){return arguments.length?(y=t,o):y},o.nonemptyOpacity=function(t){return arguments.length?(v=t,o):y},o.legendables=function(){return[{chart:o,name:o._groupName,color:o.getColor()}]},o.legendHighlight=function(e){a(function(t){return t.attr("fill")===e.color},d),o.selectAll(".chart-body path.symbol").filter(function(){return t.select(this).attr("fill")!==e.color}).classed("fadeout",!0)},o.legendReset=function(e){a(function(t){return t.attr("fill")===e.color},f),o.selectAll(".chart-body path.symbol").filter(function(){return t.select(this).attr("fill")!==e.color}).classed("fadeout",!1)},o.setHandlePaths=function(){},o.extendBrush=function(){var t=o.brush().extent();return o.round()&&(t[0]=t[0].map(o.round()),t[1]=t[1].map(o.round()),o.g().select(".brush").call(o.brush().extent(t))),t},o.brushIsEmpty=function(t){return o.brush().empty()||!t||t[0][0]>=t[1][0]||t[0][1]>=t[1][1]},o._brushing=function(){var t=o.extendBrush();if(o.redrawBrush(o.g()),o.brushIsEmpty(t))n.events.trigger(function(){o.filter(null),o.redrawGroup()});else{var e=n.filters.RangedTwoDimensionalFilter(t);n.events.trigger(function(){o.filter(null),o.filter(e),o.redrawGroup()},n.constants.EVENT_DELAY)}},o.setBrushY=function(t){t.call(o.brush().y(o.y()))},o.anchor(e,r)},n.numberDisplay=function(e,r){var i,a="number-display",o=t.format(".2s"),l=n.baseMixin({}),u={one:"",some:"",none:""};return l._mandatoryAttributes(["group"]),l.html=function(t){return arguments.length?(t.none?u.none=t.none:t.one?u.none=t.one:t.some&&(u.none=t.some),t.one?u.one=t.one:t.some&&(u.one=t.some),t.some?u.some=t.some:t.one&&(u.some=t.one),l):u},l.value=function(){return l.data()},l.data(function(t){var e=t.value?t.value():t.top(1)[0];return l.valueAccessor()(e)}),l.transitionDuration(250),l.transitionDelay(0),l._doRender=function(){var e=l.value(),n=l.selectAll("."+a);n.empty()&&(n=n.data([0]).enter().append("span").attr("class",a)),n.transition().duration(l.transitionDuration()).delay(l.transitionDelay()).ease("quad-out-in").tween("text",function(){var n=isFinite(i)?i:0,r=t.interpolateNumber(n||0,e);return i=e,function(t){var n=null,i=l.formatNumber()(r(t));0===e&&""!==u.none?n=u.none:1===e&&""!==u.one?n=u.one:""!==u.some&&(n=u.some),this.innerHTML=n?n.replace("%number",i):i}})},l._doRedraw=function(){return l._doRender()},l.formatNumber=function(t){return arguments.length?(o=t,l):o},l.anchor(e,r)},n.heatMap=function(e,r){function i(t,e){var r=f.selectAll(".box-group").filter(function(n){return n.key[t]===e}),i=r.filter(function(t){return!f.hasFilter(t.key)});n.events.trigger(function(){var t=i.empty()?r:i,e=t.data().map(function(t){return n.filters.TwoDimensionalFilter(t.key)});f._filter([e]),f.redrawGroup()})}function a(t,e,n){return!e||n[e-1]!==t}var o,l,u,s=6.75,c=s,d=s,f=n.colorMixin(n.marginMixin(n.baseMixin({})));f._mandatoryAttributes(["group"]),f.title(f.colorAccessor());var g=function(t){return t},h=function(t){return t};f.colsLabel=function(t){return arguments.length?(g=t,f):g},f.rowsLabel=function(t){return arguments.length?(h=t,f):h};var p=function(t){i(0,t)},x=function(t){i(1,t)},y=function(t){var e=t.key;n.events.trigger(function(){f.filter(e),f.redrawGroup()})};return n.override(f,"filter",function(t){return arguments.length?f._filter(n.filters.TwoDimensionalFilter(t)):f._filter()}),f.rows=function(e){if(arguments.length)return u=e,f;if(u)return u;var n=f.data().map(f.valueAccessor());return n.sort(t.ascending),t.scale.ordinal().domain(n.filter(a))},f.cols=function(e){if(arguments.length)return l=e,f;if(l)return l;var n=f.data().map(f.keyAccessor());return n.sort(t.ascending),t.scale.ordinal().domain(n.filter(a))},f._doRender=function(){return f.resetSvg(),o=f.svg().append("g").attr("class","heatmap").attr("transform","translate("+f.margins().left+","+f.margins().top+")"),f._doRedraw()},f._doRedraw=function(){var t=f.rows(),e=f.cols(),r=t.domain().length,i=e.domain().length,a=Math.floor(f.effectiveWidth()/i),l=Math.floor(f.effectiveHeight()/r);e.rangeRoundBands([0,f.effectiveWidth()]),t.rangeRoundBands([f.effectiveHeight(),0]);var u=o.selectAll("g.box-group").data(f.data(),function(t,e){return f.keyAccessor()(t,e)+"\0"+f.valueAccessor()(t,e)}),s=u.enter().append("g").attr("class","box-group");s.append("rect").attr("class","heat-box").attr("fill","white").on("click",f.boxOnClick()),f.renderTitle()&&(s.append("title"),u.select("title").text(f.title())),n.transition(u.select("rect"),f.transitionDuration(),f.transitionDelay()).attr("x",function(t,n){return e(f.keyAccessor()(t,n))}).attr("y",function(e,n){return t(f.valueAccessor()(e,n))}).attr("rx",c).attr("ry",d).attr("fill",f.getColor).attr("width",a).attr("height",l),u.exit().remove();var g=o.select("g.cols");g.empty()&&(g=o.append("g").attr("class","cols axis"));var h=g.selectAll("text").data(e.domain());h.enter().append("text").attr("x",function(t){return e(t)+a/2}).style("text-anchor","middle").attr("y",f.effectiveHeight()).attr("dy",12).on("click",f.xAxisOnClick()).text(f.colsLabel()),n.transition(h,f.transitionDuration(),f.transitionDelay()).text(f.colsLabel()).attr("x",function(t){return e(t)+a/2}).attr("y",f.effectiveHeight()),h.exit().remove();var p=o.select("g.rows");p.empty()&&(p=o.append("g").attr("class","rows axis"));var x=p.selectAll("text").data(t.domain());return x.enter().append("text").attr("dy",6).style("text-anchor","end").attr("x",0).attr("dx",-2).on("click",f.yAxisOnClick()).text(f.rowsLabel()),n.transition(x,f.transitionDuration(),f.transitionDelay()).text(f.rowsLabel()).attr("y",function(e){return t(e)+l/2}),x.exit().remove(),f.hasFilter()?f.selectAll("g.box-group").each(function(t){f.isSelectedNode(t)?f.highlightSelected(this):f.fadeDeselected(this)}):f.selectAll("g.box-group").each(function(){f.resetHighlight(this)}),f},f.boxOnClick=function(t){return arguments.length?(y=t,f):y},f.xAxisOnClick=function(t){return arguments.length?(p=t,f):p},f.yAxisOnClick=function(t){return arguments.length?(x=t,f):x},f.xBorderRadius=function(t){return arguments.length?(c=t,f):c},f.yBorderRadius=function(t){return arguments.length?(d=t,f):d},f.isSelectedNode=function(t){return f.hasFilter(t.key)},f.anchor(e,r)},function(){function e(t){return[0,t.length-1]}function n(e){return[t.quantile(e,.25),t.quantile(e,.5),t.quantile(e,.75)]}t.box=function(){function r(e){e.each(function(e,n){e=e.map(s).sort(t.ascending);var r=t.select(this),g=e.length,h=e[0],p=e[g-1],x=e.quartiles=d(e),y=c&&c.call(this,e,n),v=y&&y.map(function(t){return e[t]}),m=y?t.range(0,y[0]).concat(t.range(y[1]+1,g)):t.range(g),A=t.scale.linear().domain(u&&u.call(this,e,n)||[h,p]).range([a,0]),b=this.__chart__||t.scale.linear().domain([0,1/0]).range(A.range());this.__chart__=A;var _=r.selectAll("line.center").data(v?[v]:[]);_.enter().insert("line","rect").attr("class","center").attr("x1",i/2).attr("y1",function(t){return b(t[0])}).attr("x2",i/2).attr("y2",function(t){return b(t[1])}).style("opacity",1e-6).transition().duration(o).delay(l).style("opacity",1).attr("y1",function(t){return A(t[0])}).attr("y2",function(t){return A(t[1])}),_.transition().duration(o).delay(l).style("opacity",1).attr("x1",i/2).attr("x2",i/2).attr("y1",function(t){return A(t[0])}).attr("y2",function(t){return A(t[1])}),_.exit().transition().duration(o).delay(l).style("opacity",1e-6).attr("y1",function(t){return A(t[0])}).attr("y2",function(t){return A(t[1])}).remove();var D=r.selectAll("rect.box").data([x]);D.enter().append("rect").attr("class","box").attr("x",0).attr("y",function(t){return b(t[2])}).attr("width",i).attr("height",function(t){return b(t[0])-b(t[2])}).transition().duration(o).delay(l).attr("y",function(t){return A(t[2])}).attr("height",function(t){return A(t[0])-A(t[2])}),D.transition().duration(o).delay(l).attr("width",i).attr("y",function(t){return A(t[2])}).attr("height",function(t){return A(t[0])-A(t[2])});var k=r.selectAll("line.median").data([x[1]]);k.enter().append("line").attr("class","median").attr("x1",0).attr("y1",b).attr("x2",i).attr("y2",b).transition().duration(o).delay(l).attr("y1",A).attr("y2",A),k.transition().duration(o).delay(l).attr("x1",0).attr("x2",i).attr("y1",A).attr("y2",A);var C=r.selectAll("line.whisker").data(v||[]);C.enter().insert("line","circle, text").attr("class","whisker").attr("x1",0).attr("y1",b).attr("x2",i).attr("y2",b).style("opacity",1e-6).transition().duration(o).delay(l).attr("y1",A).attr("y2",A).style("opacity",1),C.transition().duration(o).delay(l).attr("x1",0).attr("x2",i).attr("y1",A).attr("y2",A).style("opacity",1),C.exit().transition().duration(o).delay(l).attr("y1",A).attr("y2",A).style("opacity",1e-6).remove();var L=r.selectAll("circle.outlier").data(m,Number);L.enter().insert("circle","text").attr("class","outlier").attr("r",5).attr("cx",i/2).attr("cy",function(t){return b(e[t])}).style("opacity",1e-6).transition().duration(o).delay(l).attr("cy",function(t){return A(e[t])}).style("opacity",1),L.transition().duration(o).delay(l).attr("cx",i/2).attr("cy",function(t){return A(e[t])}).style("opacity",1),L.exit().transition().duration(o).delay(l).attr("cy",function(t){return A(e[t])}).style("opacity",1e-6).remove();var S=f||A.tickFormat(8),M=r.selectAll("text.box").data(x);M.enter().append("text").attr("class","box").attr("dy",".3em").attr("dx",function(t,e){return 1&e?6:-6}).attr("x",function(t,e){return 1&e?i:0}).attr("y",b).attr("text-anchor",function(t,e){return 1&e?"start":"end"}).text(S).transition().duration(o).delay(l).attr("y",A),M.transition().duration(o).delay(l).text(S).attr("x",function(t,e){return 1&e?i:0}).attr("y",A);var R=r.selectAll("text.whisker").data(v||[]);R.enter().append("text").attr("class","whisker").attr("dy",".3em").attr("dx",6).attr("x",i).attr("y",b).text(S).style("opacity",1e-6).transition().duration(o).delay(l).attr("y",A).style("opacity",1),R.transition().duration(o).delay(l).text(S).attr("x",i).attr("y",A).style("opacity",1),R.exit().transition().duration(o).delay(l).attr("y",A).style("opacity",1e-6).remove()}),t.timer.flush()}var i=1,a=1,o=0,l=0,u=null,s=Number,c=e,d=n,f=null;return r.width=function(t){return arguments.length?(i=t,r):i},r.height=function(t){return arguments.length?(a=t,r):a},r.tickFormat=function(t){return arguments.length?(f=t,r):f},r.duration=function(t){return arguments.length?(o=t,r):o},r.domain=function(e){return arguments.length?(u=null===e?e:t.functor(e),r):u},r.value=function(t){return arguments.length?(s=t,r):s},r.whiskers=function(t){return arguments.length?(c=t,r):c},r.quartiles=function(t){return arguments.length?(d=t,r):d},r}}(),n.boxPlot=function(e,r){function i(t){return function(e){var n=e.quartiles[0],r=e.quartiles[2],i=(r-n)*t,a=-1,o=e.length;do++a;while(e[a]<n-i);do--o;while(e[o]>r+i);return[a,o]}}function a(t){var e=t.enter().append("g");e.attr("class","box").attr("transform",p).call(f).on("click",function(t){u.filter(u.keyAccessor()(t)),u.redrawGroup()})}function o(e){n.transition(e,u.transitionDuration(),u.transitionDelay()).attr("transform",p).call(f).each(function(){t.select(this).select("rect.box").attr("fill",u.getColor)})}function l(t){t.exit().remove().call(f)}var u=n.coordinateGridMixin({}),s=1.5,c=i,d=c(s),f=t.box(),g=null,h=function(t,e){return u.isOrdinal()?u.x().rangeBand():t/(1+u.boxPadding())/e};u.yAxisPadding(12),u.x(t.scale.ordinal()),u.xUnits(n.units.ordinal),u.data(function(t){return t.all().map(function(t){return t.map=function(e){return e.call(t,t)},t}).filter(function(t){var e=u.valueAccessor()(t);return 0!==e.length})}),u.boxPadding=u._rangeBandPadding,u.boxPadding(.8),u.outerPadding=u._outerRangeBandPadding,u.outerPadding(.5),u.boxWidth=function(e){return arguments.length?(h=t.functor(e),u):h};var p=function(t,e){var n=u.x()(u.keyAccessor()(t,e));return"translate("+n+", 0)"};return u._preprocessData=function(){u.elasticX()&&u.x().domain([])},u.plotData=function(){var t=h(u.effectiveWidth(),u.xUnitCount());f.whiskers(d).width(t).height(u.effectiveHeight()).value(u.valueAccessor()).domain(u.y().domain()).duration(u.transitionDuration()).tickFormat(g);var e=u.chartBodyG().selectAll("g.box").data(u.data(),u.keyAccessor());a(e),o(e),l(e),u.fadeDeselectedArea()},u.fadeDeselectedArea=function(){if(u.hasFilter())if(u.isOrdinal())u.g().selectAll("g.box").each(function(t){u.isSelectedNode(t)?u.highlightSelected(this):u.fadeDeselected(this)});else{var t=u.brush().extent(),e=t[0],n=t[1],r=u.keyAccessor();u.g().selectAll("g.box").each(function(t){var i=r(t);i<e||i>=n?u.fadeDeselected(this):u.highlightSelected(this)})}else u.g().selectAll("g.box").each(function(){u.resetHighlight(this)})},u.isSelectedNode=function(t){return u.hasFilter(u.keyAccessor()(t))},u.yAxisMin=function(){var e=t.min(u.data(),function(e){return t.min(u.valueAccessor()(e))});return n.utils.subtract(e,u.yAxisPadding())},u.yAxisMax=function(){var e=t.max(u.data(),function(e){return t.max(u.valueAccessor()(e))});return n.utils.add(e,u.yAxisPadding())},u.tickFormat=function(t){return arguments.length?(g=t,u):g},u.anchor(e,r)},n.abstractBubbleChart=n.bubbleMixin,n.baseChart=n.baseMixin,n.capped=n.capMixin,n.colorChart=n.colorMixin,n.coordinateGridChart=n.coordinateGridMixin,n.marginable=n.marginMixin,n.stackableChart=n.stackMixin,n.d3=t,n.crossfilter=e,n}if("function"==typeof define&&define.amd)define(["d3","crossfilter"],t);else if("object"==typeof module&&module.exports){var e=require("d3"),n=require("crossfilter2");"function"!=typeof n&&(n=n.crossfilter),module.exports=t(e,n)}else this.dc=t(d3,crossfilter)}();
...
var gulp=require("gulp"),concat=require("gulp-concat"),uglify=require("gulp-uglify"),del=require("del"),config={src:["*.js","!*.min.js"]};gulp.task("clean",function(){return del(["vendor/all.min.js"])}),gulp.task("scripts",["clean"],function(){return gulp.src(config.src).pipe(uglify()).pipe(concat("all.min.js")).pipe(gulp.dest(""))}),gulp.task("default",["scripts"],function(){});